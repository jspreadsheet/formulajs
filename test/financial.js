...
describe('Financial', () => {
  ...
  it('ODDLPRICE', () => {
    ...
    // expect(financial.ODDLPRICE('2008-02-07', '2008-06-15', '2007-10-15', 3.75/100, 4.05/100, 100, 4, 1)).to.approximately(99.87856733, 1e-8)
    // expect(financial.ODDLPRICE('2008-02-07', '2008-06-15', '2007-10-15', 3.75/100, 4.05/100, 100, 4, 2)).to.approximately(99.87856733, 1e-8)
    // expect(financial.ODDLPRICE('2008-02-07', '2008-06-15', '2007-10-15', 3.75/100, 4.05/100, 100, 4, 3)).to.approximately(99.87856733, 1e-8)
    ...
    // expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, 100, 1, 1)).to.approximately(99.61890029, 1e-8)
    // expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, 100, 1, 2)).to.approximately(99.61890029, 1e-8)
    // expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, 100, 1, 3)).to.approximately(99.61890029, 1e-8)
    ...
    // expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, 100, 4, 1)).to.approximately(99.61580175, 1e-8)
    // expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, 100, 4, 2)).to.approximately(99.61580175, 1e-8)
    // expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, 100, 4, 3)).to.approximately(99.61580175, 1e-8)
