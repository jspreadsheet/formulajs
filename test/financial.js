...
describe('Financial', () => {
  ...
  it('ODDLYIELD', () => {
    ...
    // expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 1, 1)).to.approximately(0.04522243, 1e-8)
    // expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 1, 2)).to.approximately(0.04522243, 1e-8)
    // expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 1, 3)).to.approximately(0.04522243, 1e-8)
    ...
    // expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 2, 1)).to.approximately(99,87916768, 1e-8)
    // expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 2, 2)).to.approximately(99,87916768, 1e-8)
    // expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 2, 3)).to.approximately(99,87916768, 1e-8)
    ...
    // expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 4, 1)).to.approximately(99,87916768, 1e-8)
    // expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 4, 2)).to.approximately(99,87916768, 1e-8)
    // expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 4, 3)).to.approximately(99,87916768, 1e-8)
