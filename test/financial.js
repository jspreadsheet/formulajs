...
describe('Financial', () => {
  ...
  it('ODDLPRICE', () => {
    expect(financial.ODDLPRICE('2008-02-07', '2008-06-15', '2007-10-15', 3.75/100, 4.05/100, 100, 1)).to.approximately(99.87828601, 1e-8)
    expect(financial.ODDLPRICE('2008-02-07', '2008-06-15', '2007-10-15', 3.75/100, 4.05/100, 100, 1, 0)).to.approximately(99.87828601, 1e-8)
    // expect(financial.ODDLPRICE('2008-02-07', '2008-06-15', '2007-10-15', 3.75/100, 4.05/100, 100, 1, 1)).to.approximately(99.87916768, 1e-8)
    // expect(financial.ODDLPRICE('2008-02-07', '2008-06-15', '2007-10-15', 3.75/100, 4.05/100, 100, 1, 2)).to.approximately(99.87916768, 1e-8)
    // expect(financial.ODDLPRICE('2008-02-07', '2008-06-15', '2007-10-15', 3.75/100, 4.05/100, 100, 1, 3)).to.approximately(99.87916768, 1e-8)
    expect(financial.ODDLPRICE('2008-02-07', '2008-06-15', '2007-10-15', 3.75/100, 4.05/100, 100, 1, 4)).to.approximately(99.87828601, 1e-8)

    expect(financial.ODDLPRICE('2008-02-07', '2008-06-15', '2007-10-15', 3.75/100, 4.05/100, 100, 2, 0)).to.approximately(99.87828601, 1e-8)
    // expect(financial.ODDLPRICE('2008-02-07', '2008-06-15', '2007-10-15', 3.75/100, 4.05/100, 100, 2, 1)).to.approximately(99.87916768, 1e-8)
    // expect(financial.ODDLPRICE('2008-02-07', '2008-06-15', '2007-10-15', 3.75/100, 4.05/100, 100, 2, 2)).to.approximately(99.87916768, 1e-8)
    // expect(financial.ODDLPRICE('2008-02-07', '2008-06-15', '2007-10-15', 3.75/100, 4.05/100, 100, 2, 3)).to.approximately(99.87916768, 1e-8)
    expect(financial.ODDLPRICE('2008-02-07', '2008-06-15', '2007-10-15', 3.75/100, 4.05/100, 100, 2, 4)).to.approximately(99.87828601, 1e-8)

    expect(financial.ODDLPRICE('2008-02-07', '2008-06-15', '2007-10-15', 3.75/100, 4.05/100, 100, 4, 0)).to.approximately(99.87828601, 1e-8)
    // expect(financial.ODDLPRICE('2008-02-07', '2008-06-15', '2007-10-15', 3.75/100, 4.05/100, 100, 4, 1)).to.approximately(99.87916768, 1e-8)
    // expect(financial.ODDLPRICE('2008-02-07', '2008-06-15', '2007-10-15', 3.75/100, 4.05/100, 100, 4, 2)).to.approximately(99.87916768, 1e-8)
    // expect(financial.ODDLPRICE('2008-02-07', '2008-06-15', '2007-10-15', 3.75/100, 4.05/100, 100, 4, 3)).to.approximately(99.87916768, 1e-8)
    expect(financial.ODDLPRICE('2008-02-07', '2008-06-15', '2007-10-15', 3.75/100, 4.05/100, 100, 4, 4)).to.approximately(99.87828601, 1e-8)
    

    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, 100, 1)).to.approximately(99.61414718, 1e-8)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, 100, 1, 0)).to.approximately(99.61414718, 1e-8)
    // expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, 100, 1, 1)).to.approximately(99.61580175, 1e-8)
    // expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, 100, 1, 2)).to.approximately(99.61580175, 1e-8)
    // expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, 100, 1, 3)).to.approximately(99.61580175, 1e-8)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, 100, 1, 4)).to.approximately(99.61414718, 1e-8)

    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, 100, 2, 0)).to.approximately(99.61414718, 1e-8)
    // expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, 100, 2, 1)).to.approximately(99.61874559, 1e-8)
    // expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, 100, 2, 2)).to.approximately(99.61874559, 1e-8)
    // expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, 100, 2, 3)).to.approximately(99.61874559, 1e-8)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, 100, 2, 4)).to.approximately(99.61414718, 1e-8)

    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, 100, 4, 0)).to.approximately(99.61414718, 1e-8)
    // expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, 100, 4, 1)).to.approximately(99.61890029, 1e-8)
    // expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, 100, 4, 2)).to.approximately(99.61890029, 1e-8)
    // expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, 100, 4, 3)).to.approximately(99.61890029, 1e-8)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, 100, 4, 4)).to.approximately(99.61414718, 1e-8)

    expect(financial.ODDLPRICE('string', '2018-06-15', '2017-10-15', 5/100, 6/100, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLPRICE('2018-02-05', 'string', '2017-10-15', 5/100, 6/100, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', 'string', 5/100, 6/100, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 'string', 6/100, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 'string', 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, 'string', 4, 0)).to.equal(error.value)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, 100, 'string', 0)).to.equal(error.value)

    expect(financial.ODDLPRICE([['2018-02-05']], '2018-06-15', '2017-10-15', 5/100, 6/100, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLPRICE('2018-02-05', [['2018-02-05']], '2017-10-15', 5/100, 6/100, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', [['2018-02-05']], 5/100, 6/100, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', [[1, 2]], 6/100, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, [[1, 2]], 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, [[1, 2]], 4, 0)).to.equal(error.value)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, 100, [[1, 2]], 0)).to.equal(error.value)

    expect(financial.ODDLPRICE(-1, '2018-06-15', '2017-10-15', 5/100, 6/100, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLPRICE('2018-02-05', -1, '2017-10-15', 5/100, 6/100, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', -1, 5/100, 6/100, 100, 4, 0)).to.equal(error.value)


    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', '0.05', 6/100, 100, 4, 0)).to.approximately(99.61, 0.1)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, '0.06', 100, 4, 0)).to.approximately(99.61, 0.1)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, '100', 4, 0)).to.approximately(99.61, 0.1)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, 100, '4', 0)).to.approximately(99.61, 0.1)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, 100, 4, '0')).to.approximately(99.61, 0.1)

    expect(financial.ODDLPRICE(true, '2018-06-15', '2017-10-15', 5/100, 6/100, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLPRICE('2018-02-05', true, '2017-10-15', 5/100, 6/100, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', true, 5/100, 6/100, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', true, 6/100, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, true, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, true, 4, 0)).to.equal(error.value)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, 100, true, 0)).to.equal(error.value)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, 100, 4, true)).to.equal(error.value)

    expect(financial.ODDLPRICE(false, '2018-06-15', '2017-10-15', 5/100, 6/100, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLPRICE('2018-02-05', false, '2017-10-15', 5/100, 6/100, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', false, 5/100, 6/100, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', false, 6/100, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, false, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, false, 4, 0)).to.equal(error.value)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, 100, false, 0)).to.equal(error.value)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, 100, 4, false)).to.equal(error.value)

    expect(financial.ODDLPRICE(undefined, '2018-06-15', '2017-10-15', 5/100, 6/100, 100, 4, 0)).to.equal(error.na)
    expect(financial.ODDLPRICE('2018-02-05', undefined, '2017-10-15', 5/100, 6/100, 100, 4, 0)).to.equal(error.na)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', undefined, 5/100, 6/100, 100, 4, 0)).to.equal(error.na)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', undefined, 6/100, 100, 4, 0)).to.equal(error.na)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, undefined, 100, 4, 0)).to.equal(error.na)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, undefined, 4, 0)).to.equal(error.na)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, 100, undefined, 0)).to.equal(error.na)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, 100, 4, undefined)).to.approximately(99.61414718, 1e-8)

    expect(financial.ODDLPRICE(null, '2018-06-15', '2017-10-15', 5/100, 6/100, 100, 4, 0)).to.equal(error.num)
    expect(financial.ODDLPRICE('2018-02-05', null, '2017-10-15', 5/100, 6/100, 100, 4, 0)).to.equal(error.num)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', null, 5/100, 6/100, 100, 4, 0)).to.equal(error.num)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', null, 6/100, 100, 4, 0)).to.approximately(97.87928221859706, 1e-8)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, null, 100, 4, 0)).to.approximately(101.80555555555556, 1e-8)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, null, 4, 0)).to.equal(error.num)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, 100, null, 0)).to.equal(error.num)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, 100, 4, null)).to.approximately(99.61414718, 1e-8)

    expect(financial.ODDLPRICE('2008-06-15', '2008-02-07', '2007-10-15', -1, 4.05/100, 100, 1)).to.equal(error.num)
    expect(financial.ODDLPRICE('2008-02-07', '2007-10-15', '2008-06-15', -1, 4.05/100, 100, 1)).to.equal(error.num)
    expect(financial.ODDLPRICE('2008-02-07', '2008-06-15', '2007-10-15', -1, 4.05/100, 100, 1)).to.equal(error.num)
    expect(financial.ODDLPRICE('2008-02-07', '2008-06-15', '2007-10-15', 3.75/100, -1, 100, 1)).to.equal(error.num)
    expect(financial.ODDLPRICE('2018-02-05', '2018-06-15', '2017-10-15', 5/100, 6/100, 100, 4, 5)).to.equal(error.num)
    
    expect(financial.ODDLPRICE('2008-02-07', '2008-06-15', '2007-10-15', 3.75/100, 4.05/100, 100, 2, 0, 1)).to.equal(error.na)
    expect(financial.ODDLPRICE('2008-02-07', '2008-06-15', '2007-10-15', 3.75/100, 4.05/100, 100)).to.equal(error.na)
    expect(financial.ODDLPRICE('2008-02-07', '2008-06-15', '2007-10-15', 3.75/100, 4.05/100)).to.equal(error.na)
    expect(financial.ODDLPRICE('2008-02-07', '2008-06-15', '2007-10-15', 3.75/100)).to.equal(error.na)
    expect(financial.ODDLPRICE('2008-02-07', '2008-06-15', '2007-10-15')).to.equal(error.na)
    expect(financial.ODDLPRICE('2008-02-07', '2008-06-15')).to.equal(error.na)
    expect(financial.ODDLPRICE('2008-02-07')).to.equal(error.na)
    expect(financial.ODDLPRICE()).to.equal(error.na)


    Object.values(error).forEach((err) => {
      expect(financial.ODDLPRICE(err, '2008-06-15', '2007-10-15', 3.75/100, 4.05/100, 100, 1, 0)).to.equal(err)
      expect(financial.ODDLPRICE('2008-02-07',err, '2007-10-15', 3.75/100, 4.05/100, 100, 1, 0)).to.equal(err)
      expect(financial.ODDLPRICE('2008-02-07', '2008-06-15', err, 3.75/100, 4.05/100, 100, 1, 0)).to.equal(err)
      expect(financial.ODDLPRICE('2008-02-07', '2008-06-15', '2007-10-15', err, 4.05/100, 100, 1, 0)).to.equal(err)
      expect(financial.ODDLPRICE('2008-02-07', '2008-06-15', '2007-10-15', 3.75/100, err, 100, 1, 0)).to.equal(err)
      expect(financial.ODDLPRICE('2008-02-07', '2008-06-15', '2007-10-15', 3.75/100, 4.05/100, err, 1, 0)).to.equal(err)
      expect(financial.ODDLPRICE('2008-02-07', '2008-06-15', '2007-10-15', 3.75/100, 4.05/100, 100, err, 0)).to.equal(err)
      expect(financial.ODDLPRICE('2008-02-07', '2008-06-15', '2007-10-15', 3.75/100, 4.05/100, 100, 1, err)).to.equal(err)
    })
  })
