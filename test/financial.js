...
describe('Financial', () => {
  ...
  it('YIELDMAT', () => {
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25/100, 100.0123)).to.approximately(0.060954334, 1e-6)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25/100, 100.0123, 0)).to.approximately(0.060954334, 1e-6)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25/100, 100.0123, 1)).to.approximately(0.060966686, 1e-6)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25/100, 100.0123, 2)).to.approximately(0.060948059, 1e-6)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25/100, 100.0123, 3)).to.approximately(0.06096363, 1e-6)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25/100, 100.0123, 4)).to.approximately(0.060954334, 1e-6)

    expect(financial.YIELDMAT('2018-02-01', '2019-01-15', '2018-01-15', 7/100, 99, 0)).to.approximately(0.081023277, 1e-6)
    expect(financial.YIELDMAT('2018-02-01', '2019-01-15', '2018-01-15', 7/100, 99, 1)).to.approximately(0.081034657, 1e-6)
    expect(financial.YIELDMAT('2018-02-01', '2019-01-15', '2018-01-15', 7/100, 99, 2)).to.approximately(0.080886317, 1e-6)
    expect(financial.YIELDMAT('2018-02-01', '2019-01-15', '2018-01-15', 7/100, 99, 3)).to.approximately(0.081034657, 1e-6)
    expect(financial.YIELDMAT('2018-02-01', '2019-01-15', '2018-01-15', 7/100, 99, 4)).to.approximately(0.081023277, 1e-6)
    ...
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25/100, 100.0123, 'test')).to.equal(error.value)
    ...
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25/100, 100.0123, true)).to.equal(error.value)
    ...
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25/100, 100.0123, false)).to.equal(error.value)
    ...
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25/100, 100.0123, null)).not.to.equal(error.value)
    ...
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25/100, 100.0123, undefined)).not.to.equal(error.na)
    
    expect(financial.YIELDMAT([['2008-03-15', '2008-03-15']], '2008-11-03', '2007-11-08', 6.25/100, 100.0123, 0)).to.equal(error.value)
    expect(financial.YIELDMAT('2008-03-15', [['2008-11-03', '2008-11-03']], '2007-11-08', 6.25/100, 100.0123, 0)).to.equal(error.value)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', [['2007-11-08', '2007-11-08']], 6.25/100, 100.0123, 0)).to.equal(error.value)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', [[6.25/100,  6.25/100]], 100.0123, 0)).to.equal(error.value)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25/100, [[100.0123, 100.0123]], 0)).to.equal(error.value)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25/100, 100.0123, [[0, 0]])).to.equal(error.value)

    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', '0.0625', 100.0123, 0)).to.approximately(0.060954334, 1e-6)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25/100, '100.0123', 0)).to.approximately(0.060954334, 1e-6)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25/100, 100.0123, '0')).to.approximately(0.060954334, 1e-6)
