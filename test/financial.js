...
describe('Financial', () => {
  ...
  it('COUPDAYBS', () => {
    ...
    expect(financial.COUPDAYBS('string', '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYBS('01/25/2011', 'string', 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYBS('01/25/2011', '11/15/2011', 'string', 0)).to.equal(error.value)
    expect(financial.COUPDAYBS('01/25/2011', '11/15/2011', 2, 'string')).to.equal(error.value)
    expect(financial.COUPDAYBS(true, '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYBS('01/25/2011', true, 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYBS('01/25/2011', '11/15/2011', true, 0)).to.equal(error.value)
    expect(financial.COUPDAYBS('01/25/2011', '11/15/2011', 2, true)).to.equal(error.value)
    expect(financial.COUPDAYBS(false, '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYBS('01/25/2011', false, 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYBS('01/25/2011', '11/15/2011', false, 0)).to.equal(error.value)
    expect(financial.COUPDAYBS('01/25/2011', '11/15/2011', 2, false)).to.equal(error.value)
    expect(financial.COUPDAYBS('true', '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYBS('01/25/2011', 'true', 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYBS('01/25/2011', '11/15/2011', 'true', 0)).to.equal(error.value)
    expect(financial.COUPDAYBS('01/25/2011', '11/15/2011', 2, 'true')).to.equal(error.value)
    expect(financial.COUPDAYBS(undefined, '11/15/2011', 2, 0)).to.equal(error.na)
    expect(financial.COUPDAYBS('01/25/2011', undefined, 2, 0)).to.equal(error.na)
    expect(financial.COUPDAYBS('01/25/2011', '11/15/2011', undefined, 0)).to.equal(error.na)
    expect(financial.COUPDAYBS('01/25/2011', '11/15/2011', 2, undefined)).to.equal(70)
    expect(financial.COUPDAYBS(null, '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYBS('01/25/2011', null, 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYBS('01/25/2011', '11/15/2011', null, 0)).to.equal(error.value)
    expect(financial.COUPDAYBS('01/25/2011', '11/15/2011', 2, null)).to.equal(error.value)
    expect(financial.COUPDAYBS([['01/25/2011', '01/25/2011']], '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYBS('01/25/2011', [['11/15/2011', '11/15/2011']], 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYBS('01/25/2011', '11/15/2011', [[2, 2]], 0)).to.equal(error.value)
    expect(financial.COUPDAYBS('01/25/2011', '11/15/2011', 2, [[0, 0]])).to.equal(error.value)
    expect(financial.COUPDAYBS([['01/25/2011'], ['01/25/2011']], '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYBS('01/25/2011', [['11/15/2011'], ['11/15/2011']], 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYBS('01/25/2011', '11/15/2011', [[2], [2]], 0)).to.equal(error.value)
    expect(financial.COUPDAYBS('01/25/2011', '11/15/2011', 2, [[0], [0]])).to.equal(error.value)
    expect(financial.COUPDAYBS('01/25/2011', '11/15/2011', 2, 0, 1)).to.equal(error.na)
    expect(financial.COUPDAYBS('01/25/2011', '11/15/2011', 2, 0, 1)).to.equal(error.na)
    expect(financial.COUPDAYBS('01/25/2011', '11/15/2011')).to.equal(error.na)
    expect(financial.COUPDAYBS('01/25/2011')).to.equal(error.na)
  ...
  it('COUPDAYS', () => {
    ...
    expect(financial.COUPDAYS('01/25/2011', '11/15/2011', 2)).to.equal(180)

    expect(financial.COUPDAYS('string', '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYS('01/25/2011', 'string', 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYS('01/25/2011', '11/15/2011', 'string', 0)).to.equal(error.value)
    expect(financial.COUPDAYS('01/25/2011', '11/15/2011', 2, 'string')).to.equal(error.value)
    expect(financial.COUPDAYS(true, '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYS('01/25/2011', true, 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYS('01/25/2011', '11/15/2011', true, 0)).to.equal(error.value)
    expect(financial.COUPDAYS('01/25/2011', '11/15/2011', 2, true)).to.equal(error.value)
    expect(financial.COUPDAYS(false, '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYS('01/25/2011', false, 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYS('01/25/2011', '11/15/2011', false, 0)).to.equal(error.value)
    expect(financial.COUPDAYS('01/25/2011', '11/15/2011', 2, false)).to.equal(error.value)
    expect(financial.COUPDAYS('true', '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYS('01/25/2011', 'true', 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYS('01/25/2011', '11/15/2011', 'true', 0)).to.equal(error.value)
    expect(financial.COUPDAYS('01/25/2011', '11/15/2011', 2, 'true')).to.equal(error.value)
    expect(financial.COUPDAYS(undefined, '11/15/2011', 2, 0)).to.equal(error.na)
    expect(financial.COUPDAYS('01/25/2011', undefined, 2, 0)).to.equal(error.na)
    expect(financial.COUPDAYS('01/25/2011', '11/15/2011', undefined, 0)).to.equal(error.na)
    expect(financial.COUPDAYS('01/25/2011', '11/15/2011', 2, undefined)).to.equal(180)
    expect(financial.COUPDAYS(null, '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYS('01/25/2011', null, 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYS('01/25/2011', '11/15/2011', null, 0)).to.equal(error.value)
    expect(financial.COUPDAYS('01/25/2011', '11/15/2011', 2, null)).to.equal(error.value)
    expect(financial.COUPDAYS([['01/25/2011', '01/25/2011']], '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYS('01/25/2011', [['11/15/2011', '11/15/2011']], 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYS('01/25/2011', '11/15/2011', [[2, 2]], 0)).to.equal(error.value)
    expect(financial.COUPDAYS('01/25/2011', '11/15/2011', 2, [[0, 0]])).to.equal(error.value)
    expect(financial.COUPDAYS([['01/25/2011'], ['01/25/2011']], '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYS('01/25/2011', [['11/15/2011'], ['11/15/2011']], 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYS('01/25/2011', '11/15/2011', [[2], [2]], 0)).to.equal(error.value)
    expect(financial.COUPDAYS('01/25/2011', '11/15/2011', 2, [[0], [0]])).to.equal(error.value)
    expect(financial.COUPDAYS('01/25/2011', '11/15/2011', 2, 0, 1)).to.equal(error.na)
    expect(financial.COUPDAYS('01/25/2011', '11/15/2011')).to.equal(error.na)
    expect(financial.COUPDAYS('01/25/2011')).to.equal(error.na)
    expect(financial.COUPDAYS()).to.equal(error.na)
  })

  it('COUPDAYSNC', () => {
    expect(financial.COUPDAYSNC('01/13/2017', '02/15/2017', 2, 1)).to.equal(33)
    expect(financial.COUPDAYSNC('string', '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYSNC('01/25/2011', 'string', 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYSNC('01/25/2011', '11/15/2011', 'string', 0)).to.equal(error.value)
    expect(financial.COUPDAYSNC('01/25/2011', '11/15/2011', 2, 'string')).to.equal(error.value)
    expect(financial.COUPDAYSNC(true, '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYSNC('01/25/2011', true, 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYSNC('01/25/2011', '11/15/2011', true, 0)).to.equal(error.value)
    expect(financial.COUPDAYSNC('01/25/2011', '11/15/2011', 2, true)).to.equal(error.value)
    expect(financial.COUPDAYSNC(false, '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYSNC('01/25/2011', false, 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYSNC('01/25/2011', '11/15/2011', false, 0)).to.equal(error.value)
    expect(financial.COUPDAYSNC('01/25/2011', '11/15/2011', 2, false)).to.equal(error.value)
    expect(financial.COUPDAYSNC('true', '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYSNC('01/25/2011', 'true', 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYSNC('01/25/2011', '11/15/2011', 'true', 0)).to.equal(error.value)
    expect(financial.COUPDAYSNC('01/25/2011', '11/15/2011', 2, 'true')).to.equal(error.value)
    expect(financial.COUPDAYSNC(undefined, '11/15/2011', 2, 0)).to.equal(error.na)
    expect(financial.COUPDAYSNC('01/25/2011', undefined, 2, 0)).to.equal(error.na)
    expect(financial.COUPDAYSNC('01/25/2011', '11/15/2011', undefined, 0)).to.equal(error.na)
    expect(financial.COUPDAYSNC('01/25/2011', '11/15/2011', 2, undefined)).to.equal(110)
    expect(financial.COUPDAYSNC(null, '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYSNC('01/25/2011', null, 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYSNC('01/25/2011', '11/15/2011', null, 0)).to.equal(error.value)
    expect(financial.COUPDAYSNC('01/25/2011', '11/15/2011', 2, null)).to.equal(error.value)
    expect(financial.COUPDAYSNC([['01/25/2011', '01/25/2011']], '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYSNC('01/25/2011', [['11/15/2011', '11/15/2011']], 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYSNC('01/25/2011', '11/15/2011', [[2, 2]], 0)).to.equal(error.value)
    expect(financial.COUPDAYSNC('01/25/2011', '11/15/2011', 2, [[0, 0]])).to.equal(error.value)
    expect(financial.COUPDAYSNC([['01/25/2011'], ['01/25/2011']], '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYSNC('01/25/2011', [['11/15/2011'], ['11/15/2011']], 2, 0)).to.equal(error.value)
    expect(financial.COUPDAYSNC('01/25/2011', '11/15/2011', [[2], [2]], 0)).to.equal(error.value)
    expect(financial.COUPDAYSNC('01/25/2011', '11/15/2011', 2, [[0], [0]])).to.equal(error.value)
    expect(financial.COUPDAYSNC('01/25/2011', '11/15/2011', 2, 0, 1)).to.equal(error.na)
    expect(financial.COUPDAYSNC('01/25/2011', '11/15/2011')).to.equal(error.na)
    expect(financial.COUPDAYSNC('01/25/2011')).to.equal(error.na)
    expect(financial.COUPDAYSNC()).to.equal(error.na)
  })

  it('COUPNCD', () => {
    expect(financial.COUPNCD('01/25/2011', '11/15/2011', 2, 0)).to.equal(40678)
    expect(financial.COUPNCD('string', '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPNCD('01/25/2011', 'string', 2, 0)).to.equal(error.value)
    expect(financial.COUPNCD('01/25/2011', '11/15/2011', 'string', 0)).to.equal(error.value)
    expect(financial.COUPNCD('01/25/2011', '11/15/2011', 2, 'string')).to.equal(error.value)
    expect(financial.COUPNCD(true, '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPNCD('01/25/2011', true, 2, 0)).to.equal(error.value)
    expect(financial.COUPNCD('01/25/2011', '11/15/2011', true, 0)).to.equal(error.value)
    expect(financial.COUPNCD('01/25/2011', '11/15/2011', 2, true)).to.equal(error.value)
    expect(financial.COUPNCD(false, '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPNCD('01/25/2011', false, 2, 0)).to.equal(error.value)
    expect(financial.COUPNCD('01/25/2011', '11/15/2011', false, 0)).to.equal(error.value)
    expect(financial.COUPNCD('01/25/2011', '11/15/2011', 2, false)).to.equal(error.value)
    expect(financial.COUPNCD('true', '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPNCD('01/25/2011', 'true', 2, 0)).to.equal(error.value)
    expect(financial.COUPNCD('01/25/2011', '11/15/2011', 'true', 0)).to.equal(error.value)
    expect(financial.COUPNCD('01/25/2011', '11/15/2011', 2, 'true')).to.equal(error.value)
    expect(financial.COUPNCD(undefined, '11/15/2011', 2, 0)).to.equal(error.na)
    expect(financial.COUPNCD('01/25/2011', undefined, 2, 0)).to.equal(error.na)
    expect(financial.COUPNCD('01/25/2011', '11/15/2011', undefined, 0)).to.equal(error.na)
    expect(financial.COUPNCD('01/25/2011', '11/15/2011', 2, undefined)).to.equal(40678)
    expect(financial.COUPNCD(null, '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPNCD('01/25/2011', null, 2, 0)).to.equal(error.value)
    expect(financial.COUPNCD('01/25/2011', '11/15/2011', null, 0)).to.equal(error.value)
    expect(financial.COUPNCD('01/25/2011', '11/15/2011', 2, null)).to.equal(error.value)
    expect(financial.COUPNCD([['01/25/2011', '01/25/2011']], '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPNCD('01/25/2011', [['11/15/2011', '11/15/2011']], 2, 0)).to.equal(error.value)
    expect(financial.COUPNCD('01/25/2011', '11/15/2011', [[2, 2]], 0)).to.equal(error.value)
    expect(financial.COUPNCD('01/25/2011', '11/15/2011', 2, [[0, 0]])).to.equal(error.value)
    expect(financial.COUPNCD([['01/25/2011'], ['01/25/2011']], '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPNCD('01/25/2011', [['11/15/2011'], ['11/15/2011']], 2, 0)).to.equal(error.value)
    expect(financial.COUPNCD('01/25/2011', '11/15/2011', [[2], [2]], 0)).to.equal(error.value)
    expect(financial.COUPNCD('01/25/2011', '11/15/2011', 2, [[0], [0]])).to.equal(error.value)
    expect(financial.COUPNCD('01/25/2011', '11/15/2011', 2, 0, 1)).to.equal(error.na)
    expect(financial.COUPNCD('01/25/2011', '11/15/2011')).to.equal(error.na)
    expect(financial.COUPNCD('01/25/2011')).to.equal(error.na)
    expect(financial.COUPNCD()).to.equal(error.na)
  })

  it('COUPNUM', () => {
    expect(financial.COUPNUM('01/25/2007', '11/15/2008', 2, 0)).to.equal(4)
    expect(financial.COUPNUM('01/25/2007', '11/15/2008', 2, 1)).to.equal(4)
    expect(financial.COUPNUM('01/25/2007', '11/15/2008', 1, 0)).to.equal(2)
    expect(financial.COUPNUM('01/25/2007', '11/15/2008', 1, 1)).to.equal(2)

    expect(financial.COUPNUM('string', '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPNUM('01/25/2011', 'string', 2, 0)).to.equal(error.value)
    expect(financial.COUPNUM('01/25/2011', '11/15/2011', 'string', 0)).to.equal(error.value)
    expect(financial.COUPNUM('01/25/2011', '11/15/2011', 2, 'string')).to.equal(error.value)
    expect(financial.COUPNUM(true, '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPNUM('01/25/2011', true, 2, 0)).to.equal(error.value)
    expect(financial.COUPNUM('01/25/2011', '11/15/2011', true, 0)).to.equal(error.value)
    expect(financial.COUPNUM('01/25/2011', '11/15/2011', 2, true)).to.equal(error.value)
    expect(financial.COUPNUM(false, '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPNUM('01/25/2011', false, 2, 0)).to.equal(error.value)
    expect(financial.COUPNUM('01/25/2011', '11/15/2011', false, 0)).to.equal(error.value)
    expect(financial.COUPNUM('01/25/2011', '11/15/2011', 2, false)).to.equal(error.value)
    expect(financial.COUPNUM('true', '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPNUM('01/25/2011', 'true', 2, 0)).to.equal(error.value)
    expect(financial.COUPNUM('01/25/2011', '11/15/2011', 'true', 0)).to.equal(error.value)
    expect(financial.COUPNUM('01/25/2011', '11/15/2011', 2, 'true')).to.equal(error.value)
    expect(financial.COUPNUM(undefined, '11/15/2011', 2, 0)).to.equal(error.na)
    expect(financial.COUPNUM('01/25/2011', undefined, 2, 0)).to.equal(error.na)
    expect(financial.COUPNUM('01/25/2011', '11/15/2011', undefined, 0)).to.equal(error.na)
    expect(financial.COUPNUM('01/25/2011', '11/15/2011', 2, undefined)).to.equal(2)
    expect(financial.COUPNUM(null, '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPNUM('01/25/2011', null, 2, 0)).to.equal(error.value)
    expect(financial.COUPNUM('01/25/2011', '11/15/2011', null, 0)).to.equal(error.value)
    expect(financial.COUPNUM('01/25/2011', '11/15/2011', 2, null)).to.equal(error.value)
    expect(financial.COUPNUM([['01/25/2011', '01/25/2011']], '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPNUM('01/25/2011', [['11/15/2011', '11/15/2011']], 2, 0)).to.equal(error.value)
    expect(financial.COUPNUM('01/25/2011', '11/15/2011', [[2, 2]], 0)).to.equal(error.value)
    expect(financial.COUPNUM('01/25/2011', '11/15/2011', 2, [[0, 0]])).to.equal(error.value)
    expect(financial.COUPNUM([['01/25/2011'], ['01/25/2011']], '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPNUM('01/25/2011', [['11/15/2011'], ['11/15/2011']], 2, 0)).to.equal(error.value)
    expect(financial.COUPNUM('01/25/2011', '11/15/2011', [[2], [2]], 0)).to.equal(error.value)
    expect(financial.COUPNUM('01/25/2011', '11/15/2011', 2, [[0], [0]])).to.equal(error.value)
    expect(financial.COUPNUM('01/25/2011', '11/15/2011', 2, 0, 1)).to.equal(error.na)
    expect(financial.COUPNUM('01/25/2011', '11/15/2011')).to.equal(error.na)
    expect(financial.COUPNUM('01/25/2011')).to.equal(error.na)
    expect(financial.COUPNUM()).to.equal(error.na)
  })

  // TODO: Solve problem on the commented case => expect(financial.COUPPCD('06/01/2012', '05/31/18', 2, 4)).to.equal(41060)
  it('COUPPCD', () => {
    ...
    expect(financial.COUPPCD('string', '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPPCD('01/25/2011', 'string', 2, 0)).to.equal(error.value)
    expect(financial.COUPPCD('01/25/2011', '11/15/2011', 'string', 0)).to.equal(error.value)
    expect(financial.COUPPCD('01/25/2011', '11/15/2011', 2, 'string')).to.equal(error.value)
    expect(financial.COUPPCD(true, '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPPCD('01/25/2011', true, 2, 0)).to.equal(error.value)
    expect(financial.COUPPCD('01/25/2011', '11/15/2011', true, 0)).to.equal(error.value)
    expect(financial.COUPPCD('01/25/2011', '11/15/2011', 2, true)).to.equal(error.value)
    expect(financial.COUPPCD(false, '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPPCD('01/25/2011', false, 2, 0)).to.equal(error.value)
    expect(financial.COUPPCD('01/25/2011', '11/15/2011', false, 0)).to.equal(error.value)
    expect(financial.COUPPCD('01/25/2011', '11/15/2011', 2, false)).to.equal(error.value)
    expect(financial.COUPPCD('true', '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPPCD('01/25/2011', 'true', 2, 0)).to.equal(error.value)
    expect(financial.COUPPCD('01/25/2011', '11/15/2011', 'true', 0)).to.equal(error.value)
    expect(financial.COUPPCD('01/25/2011', '11/15/2011', 2, 'true')).to.equal(error.value)
    expect(financial.COUPPCD(undefined, '11/15/2011', 2, 0)).to.equal(error.na)
    expect(financial.COUPPCD('01/25/2011', undefined, 2, 0)).to.equal(error.na)
    expect(financial.COUPPCD('01/25/2011', '11/15/2011', undefined, 0)).to.equal(error.na)
    expect(financial.COUPPCD('01/25/2011', '11/15/2011', 2, undefined)).to.equal(40497)
    expect(financial.COUPPCD(null, '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPPCD('01/25/2011', null, 2, 0)).to.equal(error.value)
    expect(financial.COUPPCD('01/25/2011', '11/15/2011', null, 0)).to.equal(error.value)
    expect(financial.COUPPCD('01/25/2011', '11/15/2011', 2, null)).to.equal(error.value)
    expect(financial.COUPPCD([['01/25/2011', '01/25/2011']], '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPPCD('01/25/2011', [['11/15/2011', '11/15/2011']], 2, 0)).to.equal(error.value)
    expect(financial.COUPPCD('01/25/2011', '11/15/2011', [[2, 2]], 0)).to.equal(error.value)
    expect(financial.COUPPCD('01/25/2011', '11/15/2011', 2, [[0, 0]])).to.equal(error.value)
    expect(financial.COUPPCD([['01/25/2011'], ['01/25/2011']], '11/15/2011', 2, 0)).to.equal(error.value)
    expect(financial.COUPPCD('01/25/2011', [['11/15/2011'], ['11/15/2011']], 2, 0)).to.equal(error.value)
    expect(financial.COUPPCD('01/25/2011', '11/15/2011', [[2], [2]], 0)).to.equal(error.value)
    expect(financial.COUPPCD('01/25/2011', '11/15/2011', 2, [[0], [0]])).to.equal(error.value)
    expect(financial.COUPPCD('01/25/2011', '11/15/2011', 2, 0, 1)).to.equal(error.na)
    expect(financial.COUPPCD('01/25/2011', '11/15/2011')).to.equal(error.na)
    expect(financial.COUPPCD('01/25/2011')).to.equal(error.na)
