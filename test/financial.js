...
describe('Financial', () => {
  ...
  it('AMORDEGRC', () => {
    expect(financial.AMORDEGRC(10000, '2023-01-15', '2023-05-01', 2000, 0, 0.2)).to.equal(1178)
    expect(financial.AMORDEGRC(10000, '2023-01-15', '2023-05-01', 2000, 1, 0.2)).to.equal(3529)
    expect(financial.AMORDEGRC(10000, '2023-01-15', '2023-05-01', 2000, 2, 0.2)).to.equal(2117)
    expect(financial.AMORDEGRC(10000, '2023-01-15', '2023-05-01', 2000, 3, 0.2)).to.equal(1588)
    expect(financial.AMORDEGRC(10000, '2023-01-15', '2023-05-01', 2000, 4, 0.2)).to.equal(0)

    expect(financial.AMORDEGRC(2400, '2008-08-19', '2008-12-31', 0, 0, 0.3, 1)).to.equal(395)
    expect(financial.AMORDEGRC(2400, '2008-08-19', '2008-12-31', 0, 1, 0.3, 1)).to.equal(902)
    expect(financial.AMORDEGRC(2400, '2008-08-19', '2008-12-31', 0, 2, 0.3, 1)).to.equal(551)
    expect(financial.AMORDEGRC(2400, '2008-08-19', '2008-12-31', 0, 3, 0.3, 1)).to.equal(551)

    expect(financial.AMORDEGRC(50000, '2000-01-01', '2000-06-01', 0, 0, 0.04)).to.equal(2083)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2001-01-01', 0, 0, 0.49)).to.equal(36750)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2001-06-01', 0, 0, 0.04)).to.equal(7083)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2001-06-01', 0, 0, 0.04)).to.equal(7083)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2001-06-01', 0, 1, 0.04)).to.equal(4292)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2001-06-01', 0, 2, 0.04)).to.equal(3863)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2001-06-01', 0, 3, 0.04)).to.equal(3476)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2001-06-01', 0, 4, 0.04)).to.equal(3129)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2001-06-01', 0, 5, 0.04)).to.equal(2816)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2001-06-01', 0, 6, 0.04)).to.equal(2534)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2001-06-01', 0, 7, 0.04)).to.equal(2281)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2001-06-01', 0, 8, 0.04)).to.equal(2053)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2001-06-01', 0, 9, 0.04)).to.equal(1847)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2001-06-01', 0, 10, 0.04)).to.equal(1663)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2001-06-01', 0, 11, 0.04)).to.equal(1496)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2001-06-01', 0, 12, 0.04)).to.equal(1347)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2001-06-01', 0, 13, 0.04)).to.equal(1212)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2001-06-01', 0, 14, 0.04)).to.equal(1091)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2001-06-01', 0, 15, 0.04)).to.equal(982)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2001-06-01', 0, 16, 0.04)).to.equal(884)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2001-06-01', 0, 17, 0.04)).to.equal(795)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2001-06-01', 0, 18, 0.04)).to.equal(716)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2001-06-01', 0, 19, 0.04)).to.equal(644)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2001-06-01', 0, 20, 0.04)).to.equal(580)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2001-06-01', 0, 21, 0.04)).to.equal(522)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2001-06-01', 0, 22, 0.04)).to.equal(470)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2001-06-01', 0, 23, 0.04)).to.equal(2113)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2001-06-01', 0, 24, 0.04)).to.equal(2113)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2001-06-01', 0, 25, 0.04)).to.equal(0)

    expect(financial.AMORDEGRC(23100, '2000-01-01', '2001-01-01', 22900, 0, 0.04)).to.equal(200)

    expect(financial.AMORDEGRC(23100, '2000-01-01', '2000-06-01', 150, 0, 0.09)).to.equal(2166)
    expect(financial.AMORDEGRC(23100, '2000-01-01', '2000-06-01', 150, 9, 0.09)).to.equal(613)
    expect(financial.AMORDEGRC(23100, '2000-01-01', '2000-06-01', 150, 10, 0.09)).to.equal(1056)
    expect(financial.AMORDEGRC(23100, '2000-01-01', '2000-06-01', 150, 11, 0.09)).to.equal(1056)
    expect(financial.AMORDEGRC(23100, '2000-01-01', '2000-06-01', 150, 12, 0.09)).to.equal(0)

    expect(financial.AMORDEGRC(100, '2005-06-12', '2008-12-28', 1, 0, 0.14)).to.equal(99)
    expect(financial.AMORDEGRC(100, '2005-06-12', '2008-12-28', 1, -1, 0.14)).to.equal(error.num)
    expect(financial.AMORDEGRC(100, '2005-06-12', '2008-12-28', -1, 0, 0.14)).to.equal(error.num)
    expect(financial.AMORDEGRC(0, '2005-06-12', '2008-12-28', 0, 0, 0.14)).to.equal(error.num)
    expect(financial.AMORDEGRC(100, '2005-06-12', '2008-12-28', 100, 0, 0.14)).to.equal(0)
    expect(financial.AMORDEGRC(100, '2005-06-12', '2008-12-28', 100.0000001, 0, 0.14)).to.equal(error.num)
    expect(financial.AMORDEGRC(100, '2005-06-12', '2005-06-11', 1, 0, 0.14)).to.equal(error.num)

    expect(financial.AMORDEGRC(10000, '2005-06-12', '2006-04-05', 95, 0, 0)).to.equal(error.num)
    expect(financial.AMORDEGRC(10000, '2005-06-12', '2006-04-05', 1, 0, 0.5)).to.equal(error.num)
    expect(financial.AMORDEGRC(10000, '2005-06-12', '2006-04-05', 1, 0, 0.0001)).to.equal(2)
    expect(financial.AMORDEGRC(10000, '2005-06-12', '2006-04-05', 1, 0, 0.333344445)).to.equal(4070)
    expect(financial.AMORDEGRC(10000, '2005-06-12', '2006-04-05', 1, 0, 0.333322223)).to.equal(4069)

    expect(financial.AMORDEGRC(10000, '2005-06-12', '2006-04-05', 1, 0, 0.24)).to.equal(3907)
    expect(financial.AMORDEGRC(10000, '2005-06-12', '2006-04-05', 1, 0, 0.25)).to.equal(3052)
    expect(financial.AMORDEGRC(10000, '2005-06-12', '2006-04-05', 1, 0, 0.26)).to.equal(3174)

    expect(financial.AMORDEGRC(10000, '2005-06-12', '2006-04-05', 1, 0, 0.19)).to.equal(3093)
    expect(financial.AMORDEGRC(10000, '2005-06-12', '2006-04-05', 1, 0, 0.2)).to.equal(3256)
    expect(financial.AMORDEGRC(10000, '2005-06-12', '2006-04-05', 1, 0, 0.21)).to.equal(3418)

    expect(financial.AMORDEGRC(10000, '2005-06-12', '2006-04-05', 1, 0, 0.156666667)).to.equal(3188)
    expect(financial.AMORDEGRC(10000, '2005-06-12', '2006-04-05', 1, 0, 0.166666667)).to.equal(2713)
    expect(financial.AMORDEGRC(10000, '2005-06-12', '2006-04-05', 1, 0, 0.176666667)).to.equal(2876)

    expect(financial.AMORDEGRC(100, '2005-06-12', '2005-06-12', 1, 0, 0.14)).to.equal(35)
    expect(financial.AMORDEGRC(100, '2005-06-12', '2006-06-12', 1, 0, 0.14)).to.equal(35)
    expect(financial.AMORDEGRC(100000, '2005-06-12', '2005-06-13', 1, 0, 0.14)).to.equal(97)
    expect(financial.AMORDEGRC(100000, '2005-06-12', '2006-06-13', 1, 0, 0.14)).to.equal(35097)

    expect(financial.AMORDEGRC(50000, '2000-01-01', '2000-06-01', 0, 0, 0.04)).to.equal(2083)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2000-06-01', 0, 0.9, 0.04)).to.equal(0)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2000-06-01', 0, 1, 0.04)).to.equal(4792)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2000-06-01', 0, 1.1, 0.04)).to.equal(4792)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2000-06-01', 0, 24, 0.04)).to.equal(2359)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2000-06-01', 0, 23, 0.04)).to.equal(2359)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2000-06-01', 0, 23.1, 0.04)).to.equal(2359)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2000-06-01', 0, 24.9, 0.04)).to.equal(2359)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2000-06-01', 0, 25, 0.04)).to.equal(0)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2000-06-01', 0, 25.1, 0.04)).to.equal(0)
    expect(financial.AMORDEGRC(50000, '2000-01-01', '2000-06-01', 0, 26.1, 0.04)).to.equal(0)

    expect(financial.AMORDEGRC(1643, '2010-10-30', '2012-04-14', 100, 0, 0.06, 0)).to.equal(359)
    expect(financial.AMORDEGRC('1643', '2010-10-30', '2012-04-14', 100, 0, 0.06, 0)).to.equal(359)
    expect(financial.AMORDEGRC(1643, '2010-10-30', '2012-04-14', '100', 0, 0.06, 0)).to.equal(359)
    expect(financial.AMORDEGRC(1643, '2010-10-30', '2012-04-14', 100, '0', 0.06, 0)).to.equal(359)
    expect(financial.AMORDEGRC(1643, '2010-10-30', '2012-04-14', 100, 0, '0.06', 0)).to.equal(359)
    ...
    expect(financial.AMORDEGRC([[1643, 2000]], '2010-10-30', '2012-04-14', 100, 0, 0.06, 0)).to.equal(error.value)
    expect(financial.AMORDEGRC(1643, [['2010-10-29', '2010-10-30']], '2012-04-14', 100, 0, 0.06, 0)).to.equal(
      error.value
    )
    expect(financial.AMORDEGRC(1643, '2010-10-30', [['2012-04-14', '2012-04-15']], 100, 0, 0.06, 0)).to.equal(
      error.value
    )
    expect(financial.AMORDEGRC(1643, '2010-10-30', '2012-04-14', [[100, 150]], 0, 0.06, 0)).to.equal(error.value)
    expect(financial.AMORDEGRC(1643, '2010-10-30', '2012-04-14', 100, [[0, 1]], 0.06, 0)).to.equal(error.value)
    expect(financial.AMORDEGRC(1643, '2010-10-30', '2012-04-14', 100, 0, [[0.06, 0.07]], 0)).to.equal(error.value)
    expect(financial.AMORDEGRC(1643, '2010-10-30', '2012-04-14', 100, 0, 0.06, [[0, 1]])).to.equal(error.value)

    expect(financial.AMORDEGRC('test', '2010-10-30', '2012-04-14', 100, 0, 0.06, 0)).to.equal(error.value)
    expect(financial.AMORDEGRC(1643, '2010-10-30', '2012-04-14', 'test', 0, 0.06, 0)).to.equal(error.value)
    expect(financial.AMORDEGRC(1643, '2010-10-30', '2012-04-14', 100, 'test', 0.06, 0)).to.equal(error.value)
    expect(financial.AMORDEGRC(1643, '2010-10-30', '2012-04-14', 100, 0, 'test', 0)).to.equal(error.value)
    expect(financial.AMORDEGRC(1643, '2010-10-30', '2012-04-14', 100, 0, 0.06, 'test')).to.equal(error.value)

    expect(financial.AMORDEGRC(true, '2010-10-30', '2012-04-14', 100, 0, 0.06, 0)).to.equal(error.value)
    expect(financial.AMORDEGRC(1643, '2010-10-30', '2012-04-14', true, 0, 0.06, 0)).to.equal(error.value)
    expect(financial.AMORDEGRC(1643, '2010-10-30', '2012-04-14', 100, true, 0.06, 0)).to.equal(error.value)
    expect(financial.AMORDEGRC(1643, '2010-10-30', '2012-04-14', 100, 0, true, 0)).to.equal(error.value)
    expect(financial.AMORDEGRC(1643, '2010-10-30', '2012-04-14', 100, 0, 0.06, true)).to.equal(error.value)

    expect(financial.AMORDEGRC(false, '2010-10-30', '2012-04-14', 100, 0, 0.06, 0)).to.equal(error.value)
    expect(financial.AMORDEGRC(1643, '2010-10-30', '2012-04-14', false, 0, 0.06, 0)).to.equal(error.value)
    expect(financial.AMORDEGRC(1643, '2010-10-30', '2012-04-14', 100, false, 0.06, 0)).to.equal(error.value)
    expect(financial.AMORDEGRC(1643, '2010-10-30', '2012-04-14', 100, 0, false, 0)).to.equal(error.value)
    expect(financial.AMORDEGRC(1643, '2010-10-30', '2012-04-14', 100, 0, 0.06, false)).to.equal(error.value)

    expect(financial.AMORDEGRC(100, '2005-06-12', '2006-06-13', 1, 0, 0.14, undefined)).to.equal(35)
    expect(financial.AMORDEGRC(100, '2005-06-12', '2006-06-13', 1, 0, undefined)).to.equal(error.na)
    expect(financial.AMORDEGRC(100, '2005-06-12', '2006-06-13', 1, undefined, 0.14)).to.equal(error.na)
    expect(financial.AMORDEGRC(100, '2005-06-12', '2006-06-13', undefined, 0, 0.14)).to.equal(error.na)
    expect(financial.AMORDEGRC(100, '2005-06-12', undefined, 1, 0, 0.14)).to.equal(error.na)
    expect(financial.AMORDEGRC(100, undefined, '2006-06-13', 1, 0, 0.14)).to.equal(error.na)
    expect(financial.AMORDEGRC(undefined, '2005-06-12', '2006-06-13', 1, 0, 0.14)).to.equal(error.na)

    expect(financial.AMORDEGRC(100, '2005-06-12', '2006-06-12', 1, 0, 0.14, 0)).to.equal(35)
    expect(financial.AMORDEGRC(100, '2005-06-12', '2006-06-12', 1, 0, 0.14, null)).to.equal(35)
    expect(financial.AMORDEGRC(100, '2005-06-12', '2006-06-12', 1, 0, null, 0)).to.equal(error.num)
    expect(financial.AMORDEGRC(100, '2005-06-12', '2006-06-12', 1, null, 0.14, 0)).to.equal(35)
    expect(financial.AMORDEGRC(100, '2005-06-12', '2006-06-12', null, 7, 0.14, 0)).to.equal(4)
    expect(financial.AMORDEGRC(null, '2005-06-12', '2006-06-12', 0, 0, 0.14, 0)).to.equal(error.num)

    expect(financial.AMORDEGRC(100, '2005-06-12', '2006-06-12', 1, 0, 0.14, 0, 1)).to.equal(error.na)
    expect(financial.AMORDEGRC(100, '2005-06-12', '2006-06-12', 1, 0)).to.equal(error.na)
    expect(financial.AMORDEGRC(100, '2005-06-12', '2006-06-12', 1)).to.equal(error.na)
    expect(financial.AMORDEGRC(100, '2005-06-12', '2006-06-12')).to.equal(error.na)
    expect(financial.AMORDEGRC(100, '2005-06-12')).to.equal(error.na)
    expect(financial.AMORDEGRC(100)).to.equal(error.na)
    expect(financial.AMORDEGRC()).to.equal(error.na)

    Object.values(error).forEach((err) => {
      expect(financial.AMORDEGRC(100, '2005-06-12', '2006-06-12', 1, 0, 0.14, err)).to.equal(err)
      expect(financial.AMORDEGRC(100, '2005-06-12', '2006-06-12', 1, 0, err, 0)).to.equal(err)
      expect(financial.AMORDEGRC(100, '2005-06-12', '2006-06-12', 1, err, 0.14, 0)).to.equal(err)
      expect(financial.AMORDEGRC(100, '2005-06-12', '2006-06-12', err, 0, 0.14, 0)).to.equal(err)
      expect(financial.AMORDEGRC(100, '2005-06-12', err, 1, 0, 0.14, 0)).to.equal(err)
      expect(financial.AMORDEGRC(100, err, '2006-06-12', 1, 0, 0.14, 0)).to.equal(err)
      expect(financial.AMORDEGRC(err, '2005-06-12', '2006-06-12', 1, 0, 0.14, 0)).to.equal(err)
    })

    expect(financial.AMORDEGRC(23100, '2000-01-01', '2001-01-01', 22900, 1, 0.04)).to.equal(2290)
    expect(financial.AMORDEGRC(23100, '2000-01-01', '2001-01-01', 22900, 2, 0.04)).to.equal(0)

    expect(financial.AMORDEGRC(23100, '2000-01-01', '2001-01-01', 6988, 2, 0.3)).to.equal(0)

    expect(financial.AMORDEGRC(10000, '2008-08-19', '2008-12-31', 0, 0, 0.2)).to.equal(1467)
    expect(financial.AMORDEGRC(10000, '2008-08-19', '2008-12-31', 0, 1, 0.2)).to.equal(3413)
    expect(financial.AMORDEGRC(10000, '2008-08-19', '2008-12-31', 0, 2, 0.2)).to.equal(2048)
    expect(financial.AMORDEGRC(10000, '2008-08-19', '2008-12-31', 0, 3, 0.2)).to.equal(1536)
    expect(financial.AMORDEGRC(10000, '2008-08-19', '2008-12-31', 0, 4, 0.2)).to.equal(1536)
    expect(financial.AMORDEGRC(10000, '2008-08-19', '2008-12-31', 0, 5, 0.2)).to.equal(0)

    expect(financial.AMORDEGRC(10000, '2008-08-19', '2008-12-31', 2000, 0, 0.2)).to.equal(1467)
    expect(financial.AMORDEGRC(10000, '2008-08-19', '2008-12-31', 2000, 1, 0.2)).to.equal(3413)
    expect(financial.AMORDEGRC(10000, '2008-08-19', '2008-12-31', 2000, 2, 0.2)).to.equal(2048)
    expect(financial.AMORDEGRC(10000, '2008-08-19', '2008-12-31', 2000, 3, 0.2)).to.equal(1536)
    expect(financial.AMORDEGRC(10000, '2008-08-19', '2008-12-31', 2000, 4, 0.2)).to.equal(0)

    expect(financial.AMORDEGRC(10000, '2008-08-19', '2008-12-31', 500, 0, 0.2)).to.equal(1467)
    expect(financial.AMORDEGRC(10000, '2008-08-19', '2008-12-31', 500, 1, 0.2)).to.equal(3413)
    expect(financial.AMORDEGRC(10000, '2008-08-19', '2008-12-31', 500, 2, 0.2)).to.equal(2048)
    expect(financial.AMORDEGRC(10000, '2008-08-19', '2008-12-31', 500, 3, 0.2)).to.equal(1536)
    expect(financial.AMORDEGRC(10000, '2008-08-19', '2008-12-31', 500, 4, 0.2)).to.equal(1536)
  ...
  describe('DISC', () => {
    it('should calculate the discount rate for a security', () => {
      expect(financial.DISC('2023-01-04', '2023-01-31', 99.71275, 100, 0)).to.approximately(0.0383, 1e-11)
      expect(financial.DISC('2023-01-04', '2023-01-31', 99.71275, 100)).to.approximately(0.0383, 1e-11)
      expect(financial.DISC('2023-01-04', '2023-01-31', 99.71275, 100, 1)).to.approximately(0.03883194444, 1e-11)
      expect(financial.DISC('2023-01-04', '2023-01-31', 99.71275, 100, 2)).to.approximately(0.0383, 1e-11)
      expect(financial.DISC('2023-01-04', '2023-01-31', 99.71275, 100, 3)).to.approximately(0.03883194444, 1e-11)
      expect(financial.DISC('2023-01-04', '2023-01-31', 99.71275, 100, 4)).to.approximately(0.03977307692, 1e-11)
      expect(financial.DISC('2023-01-04', '2023-12-28', 95.6145, 100, 0)).to.approximately(0.04459830508, 1e-11)
      expect(financial.DISC('2023-01-04', '2023-12-28', 95.6145, 100, 1)).to.approximately(0.0447125, 1e-11)
      expect(financial.DISC('2023-01-04', '2023-12-28', 95.6145, 100, 2)).to.approximately(0.0441, 1e-11)
      expect(financial.DISC('2023-01-04', '2023-12-28', 95.6145, 100, 3)).to.approximately(0.0447125, 1e-11)
      expect(financial.DISC('2023-01-04', '2023-12-28', 95.6145, 100, 4)).to.approximately(0.04459830508, 1e-11)
      expect(financial.DISC('2023-01-04', '2023-12-28', '95.6145', '100', '4')).to.approximately(0.04459830508, 1e-11)
    })

    it('should throw an error if input is out-of-bounds', () => {
      expect(financial.DISC('2023-01-04', '2023-01-31', -1, 100, 1)).to.equal(error.num)
      expect(financial.DISC('2023-01-04', '2023-01-31', 99.71275, -1, 1)).to.equal(error.num)
      expect(financial.DISC('2023-01-04', '2023-01-31', 99.71275, 100, -1)).to.equal(error.num)
      expect(financial.DISC('2023-01-04', '2023-01-31', 99.71275, 100, 5)).to.equal(error.num)
    })

    it('should throw an error if input is of unsupported type/format', () => {
      expect(financial.DISC('Hello World!', '2023-01-31', 99.71275, 100, 1)).to.equal(error.value)
      expect(financial.DISC('2023-01-04', 'Hello World!', 99.71275, 100, 1)).to.equal(error.value)
      expect(financial.DISC('2023-01-04', '2023-01-31', 'Hello World!', 100, 1)).to.equal(error.value)
      expect(financial.DISC('2023-01-04', '2023-01-31', 99.71275, 'Hello World!', 1)).to.equal(error.value)
      expect(financial.DISC('2023-01-04', '2023-01-31', 99.71275, 100, 'Hello World!')).to.equal(error.value)
      expect(financial.DISC(undefined, '2023-01-31', 99.71275, 100, 1)).to.equal(error.na)
      expect(financial.DISC('2023-01-04', undefined, 99.71275, 100, 1)).to.equal(error.na)
      expect(financial.DISC('2023-01-04', '2023-01-31', undefined, 100, 1)).to.equal(error.na)
      expect(financial.DISC('2023-01-04', '2023-01-31', 99.71275, undefined, 1)).to.equal(error.na)
      expect(financial.DISC(null, '2023-01-31', 99.71275, 100, 1)).to.equal(error.num)
      expect(financial.DISC('2023-01-04', null, 99.71275, 100, 1)).to.equal(error.num)
      expect(financial.DISC('2023-01-04', '2023-01-31', null, 100, 1)).to.equal(error.num)
      expect(financial.DISC('2023-01-04', '2023-01-31', 99.71275, null, 1)).to.equal(error.num)
      expect(financial.DISC(true, '2023-01-31', 99.71275, 100, 1)).to.equal(error.value)
      expect(financial.DISC('2023-01-04', true, 99.71275, 100, 1)).to.equal(error.value)
      expect(financial.DISC('2023-01-04', '2023-01-31', true, 100, 1)).to.equal(error.value)
      expect(financial.DISC('2023-01-04', '2023-01-31', 99.71275, true, 1)).to.equal(error.value)
      expect(financial.DISC('2023-01-04', '2023-01-31', 99.71275, 100, true)).to.equal(error.value)
      expect(financial.DISC([[1], [2]], '2023-01-31', 99.71275, 100, 1)).to.equal(error.value)
      expect(financial.DISC('2023-01-04', [[1], [2]], 99.71275, 100, 1)).to.equal(error.value)
      expect(financial.DISC('2023-01-04', '2023-01-31', [[1], [2]], 100, 1)).to.equal(error.value)
      expect(financial.DISC('2023-01-04', '2023-01-31', 99.71275, [[1], [2]], 1)).to.equal(error.value)
      expect(financial.DISC('2023-01-04', '2023-01-31', 99.71275, 100, [[1], [2]])).to.equal(error.value)
      expect(financial.DISC(false, '2023-01-31', 99.71275, 100, 1)).to.equal(error.value)
      expect(financial.DISC('true', '2023-01-31', 99.71275, 100, 1)).to.equal(error.value)

      Object.values(error).forEach((err) => {
        expect(financial.DISC(err, '2023-01-31', 99.71275, 100, 0)).to.equal(err)
        expect(financial.DISC('2023-01-04', err, 99.71275, 100, 0)).to.equal(err)
        expect(financial.DISC('2023-01-04', '2023-01-31', err, 100, 0)).to.equal(err)
        expect(financial.DISC('2023-01-04', '2023-01-31', 99.71275, err, 0)).to.equal(err)
        expect(financial.DISC('2023-01-04', '2023-01-31', 99.71275, 100, err)).to.equal(err)
      })
    })

    it('should throw an error if the number of arguments are invalid', () => {
      expect(financial.DISC()).to.equal(error.na)
      expect(financial.DISC('2023-01-04', '2023-12-28')).to.equal(error.na)
      expect(financial.DISC('2023-01-04', '2023-12-28', 99.71275)).to.equal(error.na)
      expect(financial.DISC('2023-01-04', '2023-12-28', 95.6145, 100, 4, 2)).to.equal(error.na)
    })

    it('should throw an error if maturity is earlier than settlement', () => {
      expect(financial.DISC('2023-01-04', '01/03/2023', 99.71275, 100, 1)).to.equal(error.value)
    })
  })
  ...
  it('PRICE', () => {
    expect(financial.PRICE('2008-02-15', '11/15/2017', 5.75 / 100, 6.5 / 100, 100, 2, 0)).to.approximately(94.63, 0.01)
    ...
    expect(financial.PRICE('string', '2016-11-15', 5.75 / 100, 95.04287, 100, 2)).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', 'string', 5.75 / 100, 95.04287, 100, 2)).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', '2016-11-15', 'string', 95.04287, 100, 2)).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, 'string', 100, 2)).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 'string', 2)).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100, 'string')).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100, 2, 'string')).to.equal(error.value)
    expect(financial.PRICE(true, '2016-11-15', 5.75 / 100, 95.04287, 100, 2)).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', true, 5.75 / 100, 95.04287, 100, 2)).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', '2016-11-15', true, 95.04287, 100, 2)).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, true, 100, 2)).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, true, 2)).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100, true)).to.equal(error.value)
    expect(financial.PRICE(false, '2016-11-15', 5.75 / 100, 95.04287, 100, 2)).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', false, 5.75 / 100, 95.04287, 100, 2)).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', '2016-11-15', false, 95.04287, 100, 2)).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, false, 100, 2)).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, false, 2)).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100, false)).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100, 2, false)).not.to.be.NaN
    expect(financial.PRICE('false', '2016-11-15', 5.75 / 100, 95.04287, 100, 2)).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', 'false', 5.75 / 100, 95.04287, 100, 2)).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', '2016-11-15', 'false', 95.04287, 100, 2)).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, 'false', 100, 2)).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 'false', 2)).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100, 'false')).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100, 2, 'false')).to.equal(error.value)
    expect(financial.PRICE('true', '2016-11-15', 5.75 / 100, 95.04287, 100, 2)).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', 'true', 5.75 / 100, 95.04287, 100, 2)).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', '2016-11-15', 'true', 95.04287, 100, 2)).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, 'true', 100, 2)).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 'true', 2)).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100, 'true')).to.equal(error.value)
    expect(financial.PRICE(null, '2016-11-15', 5.75 / 100, 95.04287, 100, 2)).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', null, 5.75 / 100, 95.04287, 100, 2)).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', '2016-11-15', null, 95.04287, 100, 2)).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, null, 100, 2)).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, null, 2)).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100, null)).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100, 2, null)).to.equal(error.value)
    expect(financial.PRICE(undefined, '2016-11-15', 5.75 / 100, 95.04287, 100, 2)).to.equal(error.na)
    expect(financial.PRICE('2008-02-15', undefined, 5.75 / 100, 95.04287, 100, 2)).to.equal(error.na)
    expect(financial.PRICE('2008-02-15', '2016-11-15', undefined, 95.04287, 100, 2)).to.equal(error.na)
    expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, undefined, 100, 2)).to.equal(error.na)
    expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, undefined, 2)).to.equal(error.na)
    expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100, undefined)).to.equal(error.na)
    expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100, 2, undefined)).not.to.be.NaN
    expect(financial.PRICE([['2008-02-15', '2008-02-15']], '2016-11-15', 5.75 / 100, 95.04287, 100, 2)).to.equal(
      error.value
    )
    expect(financial.PRICE('2008-02-15', [['2016-11-15', '2016-11-15']], 5.75 / 100, 95.04287, 100, 2)).to.equal(
      error.value
    )
    expect(financial.PRICE('2008-02-15', '2016-11-15', [[5.75, 5.75]], 95.04287, 100, 2)).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, [[95.04287, 95.04287]], 100, 2)).to.equal(
      error.value
    )
    expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, [[100, 100]], 2)).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100, [[2, 2]])).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100, 2, [[0, 0]])).to.equal(error.value)
    expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100, 2, 0, 1)).to.equal(error.na)
    expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100)).to.equal(error.na)
    expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287)).to.equal(error.na)
    expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100)).to.equal(error.na)
    expect(financial.PRICE('2008-02-15', '2016-11-15')).to.equal(error.na)
    expect(financial.PRICE('2008-02-15')).to.equal(error.na)
    expect(financial.PRICE()).to.equal(error.na)

    Object.values(error).forEach((err) => {
      expect(financial.PRICE(err, '2016-11-15', 5.75 / 100, 95.04287, 100, 2, 0)).to.equal(err)
      expect(financial.PRICE('2008-02-15', err, 5.75 / 100, 95.04287, 100, 2, 0)).to.equal(err)
      expect(financial.PRICE('2008-02-15', '2016-11-15', err, 95.04287, 100, 2, 0)).to.equal(err)
      expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, err, 100, 2, 0)).to.equal(err)
      expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, err, 2, 0)).to.equal(err)
      expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100, err, 0)).to.equal(err)
      expect(financial.PRICE('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100, 2, err)).to.equal(err)
    })
  })

  describe('PRICEDISC', () => {
    it('should calculate the price of a discounted security', () => {
      expect(financial.PRICEDISC('2023-01-05', '2023-01-31', 0.038, 100, 0)).to.approximately(99.72555556, 1e-8)
      expect(financial.PRICEDISC('2023-01-05', '2023-01-31', 0.038, 100, 1)).to.approximately(99.72931507, 1e-8)
      expect(financial.PRICEDISC('2023-01-05', '2023-01-31', 0.038, 100, 2)).to.approximately(99.72555556, 1e-8)
      expect(financial.PRICEDISC('2023-01-05', '2023-01-31', 0.038, 100, 3)).to.approximately(99.72931507, 1e-8)
      expect(financial.PRICEDISC('2023-01-05', '2023-01-31', 0.038, 100, 4)).to.approximately(99.73611111, 1e-8)
      expect(financial.PRICEDISC('2023-01-05', '2023-12-28', 0.044, 100, 0)).to.approximately(95.68555556, 1e-8)
      expect(financial.PRICEDISC('2023-01-05', '2023-12-28', 0.044, 100, 1)).to.approximately(95.69643836, 1e-8)
      expect(financial.PRICEDISC('2023-01-05', '2023-12-28', 0.044, 100, 2)).to.approximately(95.63666667, 1e-8)
      expect(financial.PRICEDISC('2023-01-05', '2023-12-28', 0.044, 100, 3)).to.approximately(95.69643836, 1e-8)
      expect(financial.PRICEDISC('2023-01-05', '2023-12-28', 0.044, 100, 4)).to.approximately(95.68555556, 1e-8)
      expect(financial.PRICEDISC('2023-01-05', '2023-12-28', '0.044', '100', '4')).to.approximately(95.68555556, 1e-8)
    })

    it('should throw an error if input is out-of-bounds', () => {
      expect(financial.PRICEDISC('2023-01-05', '2023-01-31', -1, 100, 1)).to.equal(error.num)
      expect(financial.PRICEDISC('2023-01-05', '2023-01-31', 0.038, -1, 1)).to.equal(error.num)
      expect(financial.PRICEDISC('2023-01-05', '2023-01-31', 0.038, 100, -1)).to.equal(error.num)
      expect(financial.PRICEDISC('2023-01-05', '2023-01-31', 0.038, 100, 5)).to.equal(error.num)
    })

    it('should throw an error if input is of unsupported type/format', () => {
      expect(financial.PRICEDISC('Hello World!', '2023-01-31', 0.038, 100, 1)).to.equal(error.value)
      expect(financial.PRICEDISC('2023-01-05', 'Hello World!', 0.038, 100, 1)).to.equal(error.value)
      expect(financial.PRICEDISC('2023-01-05', '2023-01-31', 'Hello World!', 100, 1)).to.equal(error.value)
      expect(financial.PRICEDISC('2023-01-05', '2023-01-31', 0.038, 'Hello World!', 1)).to.equal(error.value)
      expect(financial.PRICEDISC('2023-01-05', '2023-01-31', 0.038, 100, 'Hello World!')).to.equal(error.value)
      expect(financial.PRICEDISC(undefined, '2023-01-31', 0.038, 100, 1)).to.equal(error.value)
      expect(financial.PRICEDISC('2023-01-05', undefined, 0.038, 100, 1)).to.equal(error.value)
      expect(financial.PRICEDISC('2023-01-05', '2023-01-31', undefined, 100, 1)).to.equal(error.num)
      expect(financial.PRICEDISC('2023-01-05', '2023-01-31', 0.038, undefined, 1)).to.equal(error.num)
      expect(financial.PRICEDISC(null, '2023-01-31', 0.038, 100, 1)).to.equal(error.value)
      expect(financial.PRICEDISC('2023-01-05', null, 0.038, 100, 1)).to.equal(error.value)
      expect(financial.PRICEDISC('2023-01-05', '2023-01-31', null, 100, 1)).to.equal(error.num)
      expect(financial.PRICEDISC('2023-01-05', '2023-01-31', 0.038, null, 1)).to.equal(error.num)
      expect(financial.PRICEDISC(true, '2023-01-31', 0.038, 100, 1)).to.equal(error.value)
      expect(financial.PRICEDISC('2023-01-05', true, 0.038, 100, 1)).to.equal(error.value)
      expect(financial.PRICEDISC('true', '2023-01-31', 0.038, 100, 1)).to.equal(error.value)
      expect(financial.PRICEDISC('2023-01-05', 'true', 0.038, 100, 1)).to.equal(error.value)
      expect(financial.PRICEDISC([[1], [2]], '2023-01-31', 0.038, 100, 1)).to.equal(error.value)
      expect(financial.PRICEDISC('2023-01-05', [[1], [2]], 0.038, 100, 1)).to.equal(error.value)
      expect(financial.PRICEDISC('2023-01-05', '2023-01-31', [[1], [2]], 100, 1)).to.equal(error.value)
      expect(financial.PRICEDISC('2023-01-05', '2023-01-31', 0.038, [[1], [2]], 1)).to.equal(error.value)
      expect(financial.PRICEDISC('2023-01-05', '2023-01-31', 0.038, 100, [[1], [2]])).to.equal(error.value)
    })

    it('should throw an error if maturity is earlier than settlement', () => {
      expect(financial.PRICEDISC('2023-01-05', '2023-01-04', 0.038, 100, 1)).to.equal(error.value)
    })

    Object.values(error).forEach((err) => {
      expect(financial.PRICEDISC(err, '2023-01-31', 0.038, 100, 0)).to.equal(err)
      expect(financial.PRICEDISC('2023-01-05', err, 0.038, 100, 0)).to.equal(err)
      expect(financial.PRICEDISC('2023-01-05', '2023-01-31', err, 100, 0)).to.equal(err)
      expect(financial.PRICEDISC('2023-01-05', '2023-01-31', 0.038, err, 0)).to.equal(err)
      expect(financial.PRICEDISC('2023-01-05', '2023-01-31', 0.038, 100, err)).to.equal(err)
    })
  })

  it('PRICEMAT', () => {
    expect(financial.PRICEMAT('2008-02-15', '2008-04-13', '2007-11-11', 6.1 / 100, 6.1 / 100, 0)).to.approximately(
      99.98449888,
      1e-8
    )
    expect(financial.PRICEMAT('2017-07-01', '2027-01-01', '2017-01-01', 7 / 100, 8 / 100, 0)).to.approximately(
      93.09090909,
      1e-8
    )

    expect(financial.PRICEMAT('string', '2027-01-01', '2017-01-01', 7 / 100, 8 / 100, 0)).to.equal(error.value)
    expect(financial.PRICEMAT(false, '2027-01-01', '2017-01-01', 7 / 100, 8 / 100, 0)).to.equal(error.value)
    expect(financial.PRICEMAT(true, '2027-01-01', '2017-01-01', 7 / 100, 8 / 100, 0)).to.equal(error.value)
    expect(financial.PRICEMAT('2017-07-01', false, '2017-01-01', 7 / 100, 8 / 100, 0)).to.equal(error.value)
    expect(financial.PRICEMAT('2017-07-01', true, '2017-01-01', 7 / 100, 8 / 100, 0)).to.equal(error.value)
    expect(financial.PRICEMAT('2017-07-01', '2027-01-01', true, 8 / 100, 0)).to.equal(error.value)
    expect(financial.PRICEMAT('2017-07-01', '2027-01-01', false, 8 / 100, 0)).to.equal(error.value)
    expect(financial.PRICEMAT('2017-07-01', '2027-01-01', '2017-01-01', 7 / 100, true, 0)).to.equal(error.value)
    expect(financial.PRICEMAT('2017-07-01', '2027-01-01', '2017-01-01', 7 / 100, false, 0)).to.equal(error.value)
    expect(financial.PRICEMAT('false', '2027-01-01', '2017-01-01', 7 / 100, 8 / 100, 0)).to.equal(error.value)
    expect(financial.PRICEMAT('true', '2027-01-01', '2017-01-01', 7 / 100, 8 / 100, 0)).to.equal(error.value)
    expect(financial.PRICEMAT('2017-07-01', 'false', '2017-01-01', 7 / 100, 8 / 100, 0)).to.equal(error.value)
    expect(financial.PRICEMAT('2017-07-01', 'true', '2017-01-01', 7 / 100, 8 / 100, 0)).to.equal(error.value)
    ...
    expect(financial.PRICEMAT('2017-07-01', '2027-01-01', '2017-01-01', 7 / 100, 'true', 0)).to.equal(error.value)
    expect(financial.PRICEMAT('2017-07-01', '2027-01-01', '2017-01-01', 7 / 100, 'false', 0)).to.equal(error.value)
    expect(financial.PRICEMAT([['2017-07-01']], '2027-01-01', '2017-01-01', 7 / 100, 8 / 100, 0)).to.equal(error.value)
    expect(financial.PRICEMAT('2017-07-01', [['2027-01-01']], '2017-01-01', 7 / 100, 8 / 100, 0)).to.equal(error.value)
    expect(financial.PRICEMAT('2017-07-01', '2027-01-01', '2017-01-01', [[7 / 100]], 8 / 100, 0)).to.equal(error.value)
    expect(financial.PRICEMAT('2017-07-01', '2027-01-01', '2017-01-01', [[7 / 100, 7 / 100]], 8 / 100, 0)).to.equal(
      error.value
    )
    expect(financial.PRICEMAT('2017-07-01', '2027-01-01', 800, '2017-01-01', [[7 / 100]], 0)).to.equal(error.value)
    expect(financial.PRICEMAT('2017-07-01', '2027-01-01', 800, '2017-01-01', [[7 / 100, 7 / 100]], 0)).to.equal(
      error.value
    )
    expect(financial.PRICEMAT(null, '2027-01-01', '2017-01-01', 7 / 100, 8 / 100, 0)).to.equal(error.value)
    expect(financial.PRICEMAT(undefined, '2027-01-01', '2017-01-01', 7 / 100, 8 / 100, 0)).to.equal(error.na)
    expect(financial.PRICEMAT('2017-07-01', null, '2017-01-01', 7 / 100, 8 / 100, 0)).to.equal(error.value)
    expect(financial.PRICEMAT('2017-07-01', undefined, '2017-01-01', 7 / 100, 8 / 100, 0)).to.equal(error.na)
    expect(financial.PRICEMAT('2017-07-01', '2027-01-01', undefined, 8 / 100, 0)).to.equal(error.na)
    expect(financial.PRICEMAT('2017-07-01', '2027-01-01', null, 8 / 100, 0)).to.equal(error.value)
    expect(financial.PRICEMAT('2017-07-01', '2027-01-01', '2017-01-01', 7 / 100, undefined, 0)).to.equal(error.na)
    expect(financial.PRICEMAT('2017-07-01', '2027-01-01', '2017-01-01', 7 / 100, null, 0)).to.equal(error.value)

    expect(financial.PRICEMAT('2017-07-01', '2027-01-01', '2017-01-01', 7 / 100, 8 / 100, 0, 1)).to.equal(error.na)
    expect(financial.PRICEMAT('2017-07-01', '2027-01-01', '2017-01-01', 7 / 100)).to.equal(error.na)
    expect(financial.PRICEMAT('2017-07-01', '2027-01-01')).to.equal(error.na)
    expect(financial.PRICEMAT('2017-07-01')).to.equal(error.na)
    expect(financial.PRICEMAT()).to.equal(error.na)

    Object.values(error).forEach((err) => {
      expect(financial.PRICEMAT(err, '2027-01-01', '2017-01-01', 7 / 100, 8 / 100, 0)).to.equal(err)
      expect(financial.PRICEMAT('2017-07-01', err, '2017-01-01', 7 / 100, 8 / 100, 0)).to.equal(err)
      expect(financial.PRICEMAT('2017-07-01', '2027-01-01', err, 8 / 100, 0)).to.equal(err)
      expect(financial.PRICEMAT('2017-07-01', '2027-01-01', '2017-01-01', 7 / 100, err, 0)).to.equal(err)
      expect(financial.PRICEMAT('2017-07-01', '2027-01-01', '2017-01-01', 7 / 100, 8 / 100, err)).to.equal(err)
    })
  })
  ...
  it('TBILLEQ', () => {
    expect(financial.TBILLEQ('2008-03-31', '2008-06-01', 0.0914)).to.approximately(0.09415149356594302, 1e-9)
    expect(financial.TBILLEQ('2008-03-31', '2008-06-01', '0.0914')).to.approximately(0.09415149356594302, 1e-9)
    expect(financial.TBILLEQ('invalid date', '2008-06-01', 0.0914)).to.equal(error.value)
    expect(financial.TBILLEQ('2008-03-31', 'invalid date', 0.0914)).to.equal(error.value)
    expect(financial.TBILLEQ('2008-03-31', '2008-06-01', 'invalid')).to.equal(error.value)
    expect(financial.TBILLEQ(undefined, '2008-06-01', 0.0914)).to.equal(error.na)
    expect(financial.TBILLEQ('2008-03-31', undefined, 0.0914)).to.equal(error.na)
    expect(financial.TBILLEQ('2008-03-31', '2008-06-01', undefined)).to.equal(error.na)
    expect(financial.TBILLEQ(null, '2008-06-01', 0.0914)).to.equal(error.value)
    expect(financial.TBILLEQ('2008-03-31', null, 0.0914)).to.equal(error.value)
    expect(financial.TBILLEQ(true, '2008-06-01', 0.0914)).to.equal(error.value)
    expect(financial.TBILLEQ('2008-03-31', true, 0.0914)).to.equal(error.value)
    expect(financial.TBILLEQ('2008-03-31', '2008-06-01', null)).to.equal(error.num)
    expect(financial.TBILLEQ('2008-03-31', '2008-06-01', 0)).to.equal(error.num)
    expect(financial.TBILLEQ('09/31/2008', '2008-06-01', 0.0914)).to.equal(error.num)
    expect(financial.TBILLEQ('2008-03-31', '2009-06-01', 0.0914)).to.equal(error.num)
    expect(financial.TBILLEQ('2008-03-31', '2009-03-31', 0.0914)).to.approximately(0.10201997158449759, 1e-9)
    expect(financial.TBILLEQ('2008-03-31', '2009-04-01', 0.0914)).to.equal(error.num)
    expect(financial.TBILLEQ('2008-03-31', '2008-06-01', 0.0914, 1)).to.equal(error.na)
    expect(financial.TBILLEQ('2008-03-31', '2008-06-01')).to.equal(error.na)
    expect(financial.TBILLEQ()).to.equal(error.na)
    expect(financial.TBILLEQ([[1], [2]], '2008-06-01', 0.0914)).to.equal(error.value)
    expect(financial.TBILLEQ('2008-03-31', [[1], [2]], 0.0914)).to.equal(error.value)
    expect(financial.TBILLEQ('2008-03-31', '2008-06-01', [[1], [2]])).to.equal(error.value)

    Object.values(error).forEach((err) => {
      expect(financial.TBILLEQ(err, '2008-06-01', 0.0914)).to.equal(err)
      expect(financial.TBILLEQ('2008-03-31', err, 0.0914)).to.equal(err)
      expect(financial.TBILLEQ('2008-03-31', '2008-06-01', err)).to.equal(err)
    })
  })

  it('TBILLPRICE', () => {
    expect(financial.TBILLPRICE('2008-03-31', '2008-06-01', 0.0914)).to.approximately(98.4258888888888, 1e-9)
    expect(financial.TBILLPRICE('2008-03-31', '2008-06-01', '0.0914')).to.approximately(98.4258888888888, 1e-9)
    expect(financial.TBILLPRICE('invalid date', '2008-06-01', 0.0914)).to.equal(error.value)
    expect(financial.TBILLPRICE('2008-03-31', 'invalid date', 0.0914)).to.equal(error.value)
    expect(financial.TBILLPRICE('2008-03-31', '2008-06-01', 'invalid')).to.equal(error.value)
    expect(financial.TBILLPRICE(undefined, '2008-06-01', 0.0914)).to.equal(error.na)
    expect(financial.TBILLPRICE('2008-03-31', undefined, 0.0914)).to.equal(error.na)
    expect(financial.TBILLPRICE('2008-03-31', '2008-06-01', undefined)).to.equal(error.na)
    expect(financial.TBILLPRICE(null, '2008-06-01', 0.0914)).to.equal(error.value)
    expect(financial.TBILLPRICE('2008-03-31', null, 0.0914)).to.equal(error.value)
    expect(financial.TBILLPRICE(true, '2008-06-01', 0.0914)).to.equal(error.value)
    expect(financial.TBILLPRICE('2008-03-31', true, 0.0914)).to.equal(error.value)
    expect(financial.TBILLPRICE('2008-03-31', '2008-06-01', null)).to.equal(error.num)
    expect(financial.TBILLPRICE('2008-03-31', '2008-06-01', 0)).to.equal(error.num)
    expect(financial.TBILLPRICE('09/31/2008', '2008-06-01', 0.0914)).to.equal(error.num)
    expect(financial.TBILLPRICE('2008-03-31', '2009-06-01', 0.0914)).to.equal(error.num)
    expect(financial.TBILLPRICE('2008-03-31', '04/01/2009', 0.0914)).to.equal(error.num)
    expect(financial.TBILLPRICE('2008-03-31', '2008-06-01', 0.0914, 1)).to.equal(error.na)
    expect(financial.TBILLPRICE('2008-03-31', '2008-06-01')).to.equal(error.na)
    expect(financial.TBILLPRICE()).to.equal(error.na)
    expect(financial.TBILLPRICE([[1], [2]], '2008-06-01', 0.0914)).to.equal(error.value)
    expect(financial.TBILLPRICE('2008-03-31', [[1], [2]], 0.0914)).to.equal(error.value)
    expect(financial.TBILLPRICE('2008-03-31', '2008-06-01', [[1], [2]])).to.equal(error.value)

    Object.values(error).forEach((err) => {
      expect(financial.TBILLPRICE(err, '2008-06-01', 0.0914)).to.equal(err)
      expect(financial.TBILLPRICE('2008-03-31', err, 0.0914)).to.equal(err)
      expect(financial.TBILLPRICE('2008-03-31', '2008-06-01', err)).to.equal(err)
    })
  })

  it('TBILLYIELD', () => {
    expect(financial.TBILLYIELD('2008-03-31', '2008-06-01', 98.45)).to.approximately(0.091416962925, 1e-9)
    expect(financial.TBILLYIELD('invalid date', '2008-06-01', 0.0914)).to.equal(error.value)
    expect(financial.TBILLYIELD('2008-03-31', 'invalid date', 0.0914)).to.equal(error.value)
    expect(financial.TBILLYIELD('2008-03-31', '2008-06-01', 'invalid')).to.equal(error.value)
    expect(financial.TBILLYIELD(undefined, '2008-06-01', 0.0914)).to.equal(error.na)
    expect(financial.TBILLYIELD('2008-03-31', undefined, 0.0914)).to.equal(error.na)
    expect(financial.TBILLYIELD('2008-03-31', '2008-06-01', undefined)).to.equal(error.na)
    expect(financial.TBILLYIELD(null, '2008-06-01', 0.0914)).to.equal(error.value)
    expect(financial.TBILLYIELD('2008-03-31', null, 0.0914)).to.equal(error.value)
    expect(financial.TBILLYIELD(true, '2008-06-01', 0.0914)).to.equal(error.value)
    expect(financial.TBILLYIELD('2008-03-31', true, 0.0914)).to.equal(error.value)
    expect(financial.TBILLYIELD('2008-03-31', '2008-06-01', null)).to.equal(error.num)
    expect(financial.TBILLYIELD('2008-03-31', '2008-06-01', 0)).to.equal(error.num)
    expect(financial.TBILLYIELD('09/31/2008', '2008-06-01', 0.0914)).to.equal(error.num)
    expect(financial.TBILLYIELD('2008-03-31', '2009-06-01', 0.0914)).to.equal(error.num)
    expect(financial.TBILLYIELD('2008-03-31', '04/01/2009', 0.0914)).to.equal(error.num)
    expect(financial.TBILLYIELD('2008-03-31', '2008-06-01', 0.0914, 1)).to.equal(error.na)
    expect(financial.TBILLYIELD('2008-03-31', '2008-06-01')).to.equal(error.na)
    expect(financial.TBILLYIELD()).to.equal(error.na)
    expect(financial.TBILLYIELD([[1], [2]], '2008-06-01', 0.0914)).to.equal(error.value)
    expect(financial.TBILLYIELD('2008-03-31', [[1], [2]], 0.0914)).to.equal(error.value)
    expect(financial.TBILLYIELD('2008-03-31', '2008-06-01', [[1], [2]])).to.equal(error.value)

    Object.values(error).forEach((err) => {
      expect(financial.TBILLYIELD(err, '2008-06-01', 0.0914)).to.equal(err)
      expect(financial.TBILLYIELD('2008-03-31', err, 0.0914)).to.equal(err)
      expect(financial.TBILLYIELD('2008-03-31', '2008-06-01', err)).to.equal(err)
    })
  })
  ...
  it('YIELD', () => {
    expect(financial.YIELD(39447, 39813, 5.75 / 100, 95.04287, 100, 2)).to.approximately(0.111244505, 1e-9)
    expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100, 2, 0)).to.approximately(
      0.065000007,
      1e-9
    )
    expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100, 2)).to.approximately(
      0.065000007,
      1e-9
    )
    expect(financial.YIELD('2017-01-01', '06/30/2019', 10 / 100, 101, 100, 4)).to.approximately(9.55 / 100, 1e-3)
    expect(financial.YIELD('string', '2016-11-15', 5.75 / 100, 95.04287, 100, 2)).to.equal(error.value)
    expect(financial.YIELD('2008-02-15', 'string', 5.75 / 100, 95.04287, 100, 2)).to.equal(error.value)
    expect(financial.YIELD('2008-02-15', '2016-11-15', 'string', 95.04287, 100, 2)).to.equal(error.value)
    expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, 'string', 100, 2)).to.equal(error.value)
    expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 'string', 2)).to.equal(error.value)
    expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100, 'string')).to.equal(error.value)
    expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100, 2, 'string')).to.equal(error.value)
    expect(financial.YIELD(true, '2016-11-15', 5.75 / 100, 95.04287, 100, 2)).to.equal(error.value)
    expect(financial.YIELD('2008-02-15', true, 5.75 / 100, 95.04287, 100, 2)).to.equal(error.value)
    expect(financial.YIELD('2008-02-15', '2016-11-15', true, 95.04287, 100, 2)).to.equal(error.value)
    expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, true, 100, 2)).to.equal(error.value)
    expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, true, 2)).to.equal(error.value)
    expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100, true)).to.equal(error.value)
    expect(financial.YIELD(false, '2016-11-15', 5.75 / 100, 95.04287, 100, 2)).to.equal(error.value)
    expect(financial.YIELD('2008-02-15', false, 5.75 / 100, 95.04287, 100, 2)).to.equal(error.value)
    expect(financial.YIELD('2008-02-15', '2016-11-15', false, 95.04287, 100, 2)).to.equal(error.value)
    expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, false, 100, 2)).to.equal(error.value)
    expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, false, 2)).to.equal(error.value)
    expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100, false)).to.equal(error.value)
    expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100, 2, false)).to.approximately(
      6.5 / 100,
      1e-8
    )
    expect(financial.YIELD('false', '2016-11-15', 5.75 / 100, 95.04287, 100, 2)).to.equal(error.value)
    ...
    expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 'false', 2)).to.equal(error.value)
    expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100, 'false')).to.equal(error.value)
    expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100, 2, 'false')).to.equal(error.value)
    expect(financial.YIELD('true', '2016-11-15', 5.75 / 100, 95.04287, 100, 2)).to.equal(error.value)
    expect(financial.YIELD('2008-02-15', 'true', 5.75 / 100, 95.04287, 100, 2)).to.equal(error.value)
    expect(financial.YIELD('2008-02-15', '2016-11-15', 'true', 95.04287, 100, 2)).to.equal(error.value)
    expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, 'true', 100, 2)).to.equal(error.value)
    expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 'true', 2)).to.equal(error.value)
    expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100, 'true')).to.equal(error.value)
    expect(financial.YIELD(null, '2016-11-15', 5.75 / 100, 95.04287, 100, 2)).to.equal(error.value)
    expect(financial.YIELD('2008-02-15', null, 5.75 / 100, 95.04287, 100, 2)).to.equal(error.value)
    expect(financial.YIELD('2008-02-15', '2016-11-15', null, 95.04287, 100, 2)).to.equal(error.value)
    expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, null, 100, 2)).to.equal(error.value)
    expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, null, 2)).to.equal(error.value)
    expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100, null)).to.equal(error.value)
    expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100, 2, null)).to.equal(error.value)
    expect(financial.YIELD(undefined, '2016-11-15', 5.75 / 100, 95.04287, 100, 2)).to.equal(error.na)
    expect(financial.YIELD('2008-02-15', undefined, 5.75 / 100, 95.04287, 100, 2)).to.equal(error.na)
    expect(financial.YIELD('2008-02-15', '2016-11-15', undefined, 95.04287, 100, 2)).to.equal(error.na)
    expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, undefined, 100, 2)).to.equal(error.na)
    expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, undefined, 2)).to.equal(error.na)
    expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100, undefined)).to.equal(error.na)
    expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100, 2, undefined)).to.approximately(
      6.5 / 100,
      1e-8
    )
    expect(financial.YIELD([['2008-02-15', '2008-02-15']], '2016-11-15', 5.75 / 100, 95.04287, 100, 2)).to.equal(
      error.value
    )
    expect(financial.YIELD('2008-02-15', [['2016-11-15', '2016-11-15']], 5.75 / 100, 95.04287, 100, 2)).to.equal(
      error.value
    )
    expect(financial.YIELD('2008-02-15', '2016-11-15', [[5.75, 5.75]], 95.04287, 100, 2)).to.equal(error.value)
    expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, [[95.04287, 95.04287]], 100, 2)).to.equal(
      error.value
    )
    expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, [[100, 100]], 2)).to.equal(error.value)
    expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100, [[2, 2]])).to.equal(error.value)
    expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100, 2, [[0, 0]])).to.equal(error.value)

    expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100, 2, 0, 1)).to.equal(error.na)
    expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100)).to.equal(error.na)
    expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287)).to.equal(error.na)
    expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100)).to.equal(error.na)
    expect(financial.YIELD('2008-02-15', '2016-11-15')).to.equal(error.na)
    expect(financial.YIELD('2008-02-15')).to.equal(error.na)
    expect(financial.YIELD()).to.equal(error.na)

    Object.values(error).forEach((err) => {
      expect(financial.YIELD(err, '2016-11-15', 5.75 / 100, 95.04287, 100, 2, 0)).to.equal(err)
      expect(financial.YIELD('2008-02-15', err, 5.75 / 100, 95.04287, 100, 2, 0)).to.equal(err)
      expect(financial.YIELD('2008-02-15', '2016-11-15', err, 95.04287, 100, 2, 0)).to.equal(err)
      expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, err, 100, 2, 0)).to.equal(err)
      expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, err, 2, 0)).to.equal(err)
      expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100, err, 0)).to.equal(err)
      expect(financial.YIELD('2008-02-15', '2016-11-15', 5.75 / 100, 95.04287, 100, 2, err)).to.equal(err)
    })
  })
  ...
  it('YIELDMAT', () => {
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25 / 100, 100.0123)).to.approximately(
      0.060954334,
      1e-6
    )
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25 / 100, 100.0123, 0)).to.approximately(
      0.060954334,
      1e-6
    )
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25 / 100, 100.0123, 1)).to.approximately(
      0.060966686,
      1e-6
    )
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25 / 100, 100.0123, 2)).to.approximately(
      0.060948059,
      1e-6
    )
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25 / 100, 100.0123, 3)).to.approximately(
      0.06096363,
      1e-6
    )
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25 / 100, 100.0123, 4)).to.approximately(
      0.060954334,
      1e-6
    )

    expect(financial.YIELDMAT('2018-02-01', '2019-01-15', '2018-01-15', 7 / 100, 99, 0)).to.approximately(
      0.081023277,
      1e-6
    )
    expect(financial.YIELDMAT('2018-02-01', '2019-01-15', '2018-01-15', 7 / 100, 99, 1)).to.approximately(
      0.081034657,
      1e-6
    )
    expect(financial.YIELDMAT('2018-02-01', '2019-01-15', '2018-01-15', 7 / 100, 99, 2)).to.approximately(
      0.080886317,
      1e-6
    )
    expect(financial.YIELDMAT('2018-02-01', '2019-01-15', '2018-01-15', 7 / 100, 99, 3)).to.approximately(
      0.081034657,
      1e-6
    )
    expect(financial.YIELDMAT('2018-02-01', '2019-01-15', '2018-01-15', 7 / 100, 99, 4)).to.approximately(
      0.081023277,
      1e-6
    )

    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 0, 100.0123, 0)).not.to.equal(error.num)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', -1, 100.0123, 0)).to.equal(error.num)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25 / 100, 0, 0)).to.equal(error.num)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25 / 100, -1, 0)).to.equal(error.num)

    expect(financial.YIELDMAT('test', '2008-11-03', '2007-11-08', 6.25 / 100, 100.0123, 0)).to.equal(error.value)
    expect(financial.YIELDMAT('2008-03-15', 'test', '2007-11-08', 6.25 / 100, 100.0123, 0)).to.equal(error.value)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', 'test', 6.25 / 100, 100.0123, 0)).to.equal(error.value)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 'test', 100.0123, 0)).to.equal(error.value)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25 / 100, 'test', 0)).to.equal(error.value)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25 / 100, 100.0123, 'test')).to.equal(
      error.value
    )

    expect(financial.YIELDMAT(true, '2008-11-03', '2007-11-08', 6.25 / 100, 100.0123, 0)).to.equal(error.value)
    expect(financial.YIELDMAT('2008-03-15', true, '2007-11-08', 6.25 / 100, 100.0123, 0)).to.equal(error.value)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', true, 6.25 / 100, 100.0123, 0)).to.equal(error.value)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', true, 100.0123, 0)).to.equal(error.value)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25 / 100, true, 0)).to.equal(error.value)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25 / 100, 100.0123, true)).to.equal(
      error.value
    )

    expect(financial.YIELDMAT(false, '2008-11-03', '2007-11-08', 6.25 / 100, 100.0123, 0)).to.equal(error.value)
    expect(financial.YIELDMAT('2008-03-15', false, '2007-11-08', 6.25 / 100, 100.0123, 0)).to.equal(error.value)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', false, 6.25 / 100, 100.0123, 0)).to.equal(error.value)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', false, 100.0123, 0)).to.equal(error.value)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25 / 100, false, 0)).to.equal(error.value)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25 / 100, 100.0123, false)).to.equal(
      error.value
    )

    expect(financial.YIELDMAT(null, '2008-11-03', '2007-11-08', 6.25 / 100, 100.0123, 0)).to.equal(error.num)
    expect(financial.YIELDMAT('2008-03-15', null, '2007-11-08', 6.25 / 100, 100.0123, 0)).to.equal(error.num)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', null, 6.25 / 100, 100.0123, 0)).to.equal(error.num)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', null, 100.0123, 0)).not.to.equal(error.num)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25 / 100, null, 0)).to.equal(error.num)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25 / 100, 100.0123, null)).not.to.equal(
      error.value
    )

    expect(financial.YIELDMAT(undefined, '2008-11-03', '2007-11-08', 6.25 / 100, 100.0123, 0)).to.equal(error.na)
    expect(financial.YIELDMAT('2008-03-15', undefined, '2007-11-08', 6.25 / 100, 100.0123, 0)).to.equal(error.na)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', undefined, 6.25 / 100, 100.0123, 0)).to.equal(error.na)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', undefined, 100.0123, 0)).to.equal(error.na)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25 / 100, undefined, 0)).to.equal(error.na)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25 / 100, 100.0123, undefined)).not.to.equal(
      error.na
    )

    expect(
      financial.YIELDMAT([['2008-03-15', '2008-03-15']], '2008-11-03', '2007-11-08', 6.25 / 100, 100.0123, 0)
    ).to.equal(error.value)
    expect(
      financial.YIELDMAT('2008-03-15', [['2008-11-03', '2008-11-03']], '2007-11-08', 6.25 / 100, 100.0123, 0)
    ).to.equal(error.value)
    expect(
      financial.YIELDMAT('2008-03-15', '2008-11-03', [['2007-11-08', '2007-11-08']], 6.25 / 100, 100.0123, 0)
    ).to.equal(error.value)
    expect(
      financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', [[6.25 / 100, 6.25 / 100]], 100.0123, 0)
    ).to.equal(error.value)
    expect(
      financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25 / 100, [[100.0123, 100.0123]], 0)
    ).to.equal(error.value)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25 / 100, 100.0123, [[0, 0]])).to.equal(
      error.value
    )

    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', '0.0625', 100.0123, 0)).to.approximately(
      0.060954334,
      1e-6
    )
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25 / 100, '100.0123', 0)).to.approximately(
    ...
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25 / 100, 100.0123, 0, 1)).to.equal(error.na)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 6.25 / 100)).to.equal(error.na)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08')).to.equal(error.na)
    expect(financial.YIELDMAT('2008-03-15', '2008-11-03')).to.equal(error.na)
    expect(financial.YIELDMAT('2008-03-15')).to.equal(error.na)
    expect(financial.YIELDMAT()).to.equal(error.na)

    Object.values(error).forEach((err) => {
      expect(financial.YIELDMAT(err, '2008-11-03', '2007-11-08', 0.0625, 100.0123, 0)).to.equal(err)
      expect(financial.YIELDMAT('2008-03-15', err, '2007-11-08', 0.0625, 100.0123, 0)).to.equal(err)
      expect(financial.YIELDMAT('2008-03-15', '2008-11-03', err, 0.0625, 100.0123, 0)).to.equal(err)
      expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', err, 100.0123, 0)).to.equal(err)
      expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 0.0625, err, 0)).to.equal(err)
      expect(financial.YIELDMAT('2008-03-15', '2008-11-03', '2007-11-08', 0.0625, 100.0123, err)).to.equal(err)
    })
  })
})
