...
describe('Financial', () => {
  ...
  it('ODDLYIELD', () => {
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 1)).to.approximately(0.045192236, 1e-8)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 1, 0)).to.approximately(0.045192236, 1e-8)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 1, 1)).to.approximately(0.045179885, 1e-8)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 1, 2)).to.approximately(0.045179885, 1e-8)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 1, 3)).to.approximately(0.045179885, 1e-8)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 1, 4)).to.approximately(0.045192236, 1e-8)

    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 2, 0)).to.approximately(0.045192236, 1e-8)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 2, 1)).to.approximately(0.045179885, 1e-8)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 2, 2)).to.approximately(0.045179885, 1e-8)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 2, 3)).to.approximately(0.045179885, 1e-8)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 2, 4)).to.approximately(0.045192236, 1e-8)

    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 4, 0)).to.approximately(0.045192236, 1e-8)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 4, 1)).to.equal(error.error)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 4, 2)).to.equal(error.error)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 4, 3)).to.equal(error.error)
    // expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 4, 1)).to.approximately(0.04522243, 1e-8)
    // expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 4, 2)).to.approximately(0.04522243, 1e-8)
    // expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 4, 3)).to.approximately(0.04522243, 1e-8)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 4, 4)).to.approximately(0.045192236, 1e-8)

    expect(financial.ODDLYIELD('string', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLYIELD('2008-04-20', 'string', '2007-12-24', 3.75/100, 99.875, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', 'string', 3.75/100, 99.875, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 'string', 99.875, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 'string', 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 'string', 4, 0)).to.equal(error.value)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 'string', 0)).to.equal(error.value)

    expect(financial.ODDLYIELD([['2008-04-20']], '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLYIELD('2008-04-20', [['2008-04-20']], '2007-12-24', 3.75/100, 99.875, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', [['2008-04-20']], 3.75/100, 99.875, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', [[1, 2]], 99.875, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, [[1, 2]], 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, [[1, 2]], 4, 0)).to.equal(error.value)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, [[1, 2]], 0)).to.equal(error.value)

    expect(financial.ODDLYIELD(-1, '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLYIELD('2008-04-20', -1, '2007-12-24', 3.75/100, 99.875, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', -1, 3.75/100, 99.875, 100, 4, 0)).to.equal(error.value)


    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', '0.0375', 99.875, 100, 4, 0)).to.approximately(0.04519223562916898, 1e-9)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, '99.875', 100, 4, 0)).to.approximately(0.04519223562916898, 1e-9)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, '100', 4, 0)).to.approximately(0.04519223562916898, 1e-9)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, '4', 0)).to.approximately(0.04519223562916898, 1e-9)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 4, '0')).to.approximately(0.04519223562916898, 1e-9)

    expect(financial.ODDLYIELD(true, '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLYIELD('2008-04-20', true, '2007-12-24', 3.75/100, 99.875, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', true, 3.75/100, 99.875, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', true, 99.875, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, true, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, true, 4, 0)).to.equal(error.value)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, true, 0)).to.equal(error.value)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 4, true)).to.equal(error.value)

    expect(financial.ODDLYIELD(false, '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLYIELD('2008-04-20', false, '2007-12-24', 3.75/100, 99.875, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', false, 3.75/100, 99.875, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', false, 99.875, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, false, 100, 4, 0)).to.equal(error.value)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, false, 4, 0)).to.equal(error.value)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, false, 0)).to.equal(error.value)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 4, false)).to.equal(error.value)

    expect(financial.ODDLYIELD(undefined, '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 4, 0)).to.equal(error.na)
    expect(financial.ODDLYIELD('2008-04-20', undefined, '2007-12-24', 3.75/100, 99.875, 100, 4, 0)).to.equal(error.na)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', undefined, 3.75/100, 99.875, 100, 4, 0)).to.equal(error.na)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', undefined, 99.875, 100, 4, 0)).to.equal(error.na)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, undefined, 100, 4, 0)).to.equal(error.na)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, undefined, 4, 0)).to.equal(error.na)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, undefined, 0)).to.equal(error.na)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 4, undefined)).to.approximately(0.045192236, 1e-8)

    expect(financial.ODDLYIELD(null, '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 4, 0)).to.equal(error.num)
    expect(financial.ODDLYIELD('2008-04-20', null, '2007-12-24', 3.75/100, 99.875, 100, 4, 0)).to.equal(error.num)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', null, 3.75/100, 99.875, 100, 4, 0)).to.equal(error.num)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', null, 99.875, 100, 4, 0)).to.approximately(0.008, 1e-3)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, null, 100, 4, 0)).to.equal(error.num)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, null, 4, 0)).to.equal(error.num)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, null, 0)).to.equal(error.num)
    expect(financial.ODDLYIELD('2008-04-20', '2008-06-15', '2007-12-24', 3.75/100, 99.875, 100, 4, null)).to.approximately(0.045192236, 1e-8)
    
    expect(financial.ODDLYIELD('2008-02-07', '2008-06-15', '2007-10-15', 3.75/100, 99.875, 100, 2, 0, 1)).to.equal(error.na)
    expect(financial.ODDLYIELD('2008-02-07', '2008-06-15', '2007-10-15', 3.75/100, 99.875, 100)).to.equal(error.na)
    expect(financial.ODDLYIELD('2008-02-07', '2008-06-15', '2007-10-15', 3.75/100, 99.875)).to.equal(error.na)
    expect(financial.ODDLYIELD('2008-02-07', '2008-06-15', '2007-10-15', 3.75/100)).to.equal(error.na)
    expect(financial.ODDLYIELD('2008-02-07', '2008-06-15', '2007-10-15')).to.equal(error.na)
    expect(financial.ODDLYIELD('2008-02-07', '2008-06-15')).to.equal(error.na)
    expect(financial.ODDLYIELD('2008-02-07')).to.equal(error.na)
    expect(financial.ODDLYIELD()).to.equal(error.na)


    Object.values(error).forEach((err) => {
      expect(financial.ODDLYIELD(err, '2008-06-15', '2007-10-15', 3.75/100, 99.875, 100, 1, 0)).to.equal(err)
      expect(financial.ODDLYIELD('2008-02-07',err, '2007-10-15', 3.75/100, 99.875, 100, 1, 0)).to.equal(err)
      expect(financial.ODDLYIELD('2008-02-07', '2008-06-15', err, 3.75/100, 99.875, 100, 1, 0)).to.equal(err)
      expect(financial.ODDLYIELD('2008-02-07', '2008-06-15', '2007-10-15', err, 99.875, 100, 1, 0)).to.equal(err)
      expect(financial.ODDLYIELD('2008-02-07', '2008-06-15', '2007-10-15', 3.75/100, err, 100, 1, 0)).to.equal(err)
      expect(financial.ODDLYIELD('2008-02-07', '2008-06-15', '2007-10-15', 3.75/100, 99.875, err, 1, 0)).to.equal(err)
      expect(financial.ODDLYIELD('2008-02-07', '2008-06-15', '2007-10-15', 3.75/100, 99.875, 100, err, 0)).to.equal(err)
      expect(financial.ODDLYIELD('2008-02-07', '2008-06-15', '2007-10-15', 3.75/100, 99.875, 100, 1, err)).to.equal(err)
    })
  })
