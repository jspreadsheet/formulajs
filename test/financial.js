...
describe('Financial', () => {
  ...
  it('AMORDEGRC', () => {
    ...
    expect(financial.AMORDEGRC(10000, '2005-06-12', '2008-12-28', 1, 0, 0.5)).to.equal(error.num)
    expect(financial.AMORDEGRC(10000, '2005-06-12', '2008-12-28', 1, 0, 0.0001)).to.equal(2)
    expect(financial.AMORDEGRC(10000, '2005-06-12', '2008-12-28', 1, 0, 0.333344445)).to.equal(4070)
    expect(financial.AMORDEGRC(10000, '2005-06-12', '2008-12-28', 1, 0, 0.333322223)).to.equal(4069)

    expect(financial.AMORDEGRC(10000, '2005-06-12', '2008-12-28', 1, 0, 0.24)).to.equal(3907)
    expect(financial.AMORDEGRC(10000, '2005-06-12', '2008-12-28', 1, 0, 0.25)).to.equal(3052)
    expect(financial.AMORDEGRC(10000, '2005-06-12', '2008-12-28', 1, 0, 0.26)).to.equal(3174)

    expect(financial.AMORDEGRC(10000, '2005-06-12', '2008-12-28', 1, 0, 0.19)).to.equal(3093)
    expect(financial.AMORDEGRC(10000, '2005-06-12', '2008-12-28', 1, 0, 0.2)).to.equal(3256)
    expect(financial.AMORDEGRC(10000, '2005-06-12', '2008-12-28', 1, 0, 0.21)).to.equal(3418)

    expect(financial.AMORDEGRC(10000, '2005-06-12', '2008-12-28', 1, 0, 0.156666667)).to.equal(3188)
    expect(financial.AMORDEGRC(10000, '2005-06-12', '2008-12-28', 1, 0, 0.166666667)).to.equal(2713)
    expect(financial.AMORDEGRC(10000, '2005-06-12', '2008-12-28', 1, 0, 0.176666667)).to.equal(2876)
    ...
    expect(financial.AMORDEGRC(100, '2005-06-12', '2006-06-12', null, 0, 0.14, 0)).to.equal(4)
    ...
    // Tests whose results appear to be incorrect
    expect(financial.AMORDEGRC(23100, '2000-01-01', '2001-01-01', 22900, 1, 0.04)).to.equal(2290)

    expect(financial.AMORDEGRC(10000, '2008-08-19', '2008-12-31', 0, 0, 0.02)).to.equal(1467)
    expect(financial.AMORDEGRC(10000, '2008-08-19', '2008-12-31', 0, 1, 0.02)).to.equal(3413)
    expect(financial.AMORDEGRC(10000, '2008-08-19', '2008-12-31', 0, 2, 0.02)).to.equal(2048)
    expect(financial.AMORDEGRC(10000, '2008-08-19', '2008-12-31', 0, 3, 0.02)).to.equal(1536)
    expect(financial.AMORDEGRC(10000, '2008-08-19', '2008-12-31', 0, 4, 0.02)).to.equal(1536)
    expect(financial.AMORDEGRC(10000, '2008-08-19', '2008-12-31', 0, 5, 0.02)).to.equal(0)

    expect(financial.AMORDEGRC(10000, '2008-08-19', '2008-12-31', 2000, 0, 0.02)).to.equal(1467)
    expect(financial.AMORDEGRC(10000, '2008-08-19', '2008-12-31', 2000, 1, 0.02)).to.equal(3413)
    expect(financial.AMORDEGRC(10000, '2008-08-19', '2008-12-31', 2000, 2, 0.02)).to.equal(2048)
    expect(financial.AMORDEGRC(10000, '2008-08-19', '2008-12-31', 2000, 3, 0.02)).to.equal(1536)
    expect(financial.AMORDEGRC(10000, '2008-08-19', '2008-12-31', 2000, 4, 0.02)).to.equal(0)

    expect(financial.AMORDEGRC(10000, '2008-08-19', '2008-12-31', 500, 0, 0.02)).to.equal(1467)
    expect(financial.AMORDEGRC(10000, '2008-08-19', '2008-12-31', 500, 1, 0.02)).to.equal(3413)
    expect(financial.AMORDEGRC(10000, '2008-08-19', '2008-12-31', 500, 2, 0.02)).to.equal(2048)
    expect(financial.AMORDEGRC(10000, '2008-08-19', '2008-12-31', 500, 3, 0.02)).to.equal(1536)
    expect(financial.AMORDEGRC(10000, '2008-08-19', '2008-12-31', 500, 4, 0.02)).to.equal(1536)
    expect(financial.AMORDEGRC(10000, '2008-08-19', '2008-12-31', 500, 5, 0.02)).to.equal(0)
  })
